...
deities = 
{
	...
	gods =
	{
...

		{
			...
			cult_centre_region_key = "phar_main_buto_sais",
		...
		{
			key = "nephthys",
			localised_name = "phar_local_deities_nephthys",
			localised_flavour = "phar_map_local_deities_nephthys_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_nephthys_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_nephthys.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_nephthys.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_nephthys.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_nephthys.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_nephthys.png",
			culture = "phar_main_clt_kemets",
			epithet = "phar_map_local_deities_epithet_nephthys",
			realms =
			{
				"egyptian_upper_egypt_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_nephthys",
			shrine_chain = "phar_map_ers_shrine_nephthys",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_nephthys",
			cult_centre_region_key = "phar_main_abydos_abydos",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_nephthys",
			event_message_id = 5782,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_nephthys_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_nephthys_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_main_elephantine_hierakonpolis",
		...
		{
			key = "hathor",
			localised_name = "phar_local_deities_hathor",
			localised_flavour = "phar_map_local_deities_hathor_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hathor_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hathor.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hathor.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hathor.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hathor.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hathor.png",
			culture = "phar_main_clt_kemets",
			epithet = "phar_map_local_deities_epithet_hathor",
			realms =
			{
				"egyptian_upper_egypt_realm",
				"egyptian_lower_egypt_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hathor",
			shrine_chain = "phar_map_ers_shrine_hathor",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hathor",
			cult_centre_region_key = "phar_main_abydos_abydos",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hathor",
			event_message_id = 5770,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hathor_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hathor_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_main_herakleopolis_herakleopolis",
		...
		{
			key = "maat",
			localised_name = "phar_local_deities_maat",
			localised_flavour = "phar_map_local_deities_maat_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_maat_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_maat.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_maat.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_maat.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_maat.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_maat.png",
			culture = "phar_main_clt_kemets",
			epithet = "phar_map_local_deities_epithet_maat",
			realms =
			{
				"egyptian_upper_egypt_realm",
				"egyptian_lower_egypt_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_maat",
			shrine_chain = "phar_map_ers_shrine_maat",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_maat",
			cult_centre_region_key = "phar_main_thebes_thebes",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_maat",
			event_message_id = 5776,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_maat_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_maat_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "bastet",
			localised_name = "phar_local_deities_bastet",
			localised_flavour = "phar_map_local_deities_bastet_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_bastet_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_bastet.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_bastet.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_bastet.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_bastet.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_bastet.png",
			culture = "phar_main_clt_kemets",
			epithet = "phar_map_local_deities_epithet_bastet",
			realms =
			{
				"egyptian_lower_egypt_realm",
				"egyptian_nubia_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_bastet",
			shrine_chain = "phar_map_ers_shrine_bastet",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_bastet",
			cult_centre_region_key = "phar_main_heliopolis_heliopolis",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_bastet",
			event_message_id = 5764,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_bastet_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_bastet_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "sekhmet",
			localised_name = "phar_local_deities_sekhmet",
			localised_flavour = "phar_map_local_deities_sekhmet_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_sekhmet_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_sekhmet.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_sekhmet.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_sekhmet.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_sekhmet.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_sekhmet.png",
			culture = "phar_main_clt_kemets",
			epithet = "phar_map_local_deities_epithet_sekhmet",
			realms =
			{
				"egyptian_lower_egypt_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_sekhmet",
			shrine_chain = "phar_map_ers_shrine_sekhmet",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_sekhmet",
			cult_centre_region_key = "phar_main_heliopolis_heliopolis",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_sekhmet",
			event_message_id = 5788,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sekhmet_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sekhmet_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "sobek",
			localised_name = "phar_local_deities_sobek",
			localised_flavour = "phar_map_local_deities_sobek_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_sobek_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_sobek.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_sobek.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_sobek.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_sobek.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_sobek.png",
			culture = "phar_main_clt_kemets",
			epithet = "phar_map_local_deities_epithet_sobek",
			realms =
			{
				"egyptian_lower_egypt_realm",
				"egyptian_upper_egypt_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_sobek",
			shrine_chain = "phar_map_ers_shrine_sobek",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_sobek",
			cult_centre_region_key = "phar_main_faiyum_faiyum",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_sobek",
			event_message_id = 5794,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sobek_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sobek_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_main_ashkelon_urushalim",
		...
		
		{
			...
			cult_centre_region_key = "phar_main_aleppo_aleppo",
		...
		{
			key = "anat",
			localised_name = "phar_local_deities_anat",
			localised_flavour = "phar_map_local_deities_anat_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_anat_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_anat.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_anat.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_anat.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_anat.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_anat.png",
			culture = "phar_main_clt_canaan",
			epithet = "phar_map_local_deities_epithet_anat",
			realms =
			{
			...
			temple_chain = "phar_map_religion_temple_aegean_anat",
			shrine_chain = "phar_map_ers_shrine_anat",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_anat",
			cult_centre_region_key = "phar_map_suhum_elu_anat",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_anat",
			event_message_id = 5740,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anat_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anat_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "astarte",
			localised_name = "phar_local_deities_astarte",
			localised_flavour = "phar_map_local_deities_astarte_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_astarte_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_astarte.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_astarte.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_astarte.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_astarte.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_astarte.png",
			culture = "phar_main_clt_canaan",
			epithet = "phar_map_local_deities_epithet_astarte",
			realms =
			{
				"canaanite_retjenu_realm",
				"canaanite_yamhad_realm",
			...
			temple_chain = "phar_map_religion_temple_aegean_astarte",
			shrine_chain = "phar_map_ers_shrine_astarte",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_astarte",
			cult_centre_region_key = "phar_main_emar_emar",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_astarte",
			event_message_id = 5746,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_astarte_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_astarte_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "mot",
			localised_name = "phar_local_deities_mot",
			localised_flavour = "phar_map_local_deities_mot_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_mot_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_mot.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_mot.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_mot.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_mot.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_mot.png",
			culture = "phar_main_clt_canaan",
			epithet = "phar_map_local_deities_epithet_mot",
			realms =
			{
				"canaanite_yamhad_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_mot",
			shrine_chain = "phar_map_ers_shrine_mot",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_mot",
			cult_centre_region_key = "phar_main_ugarit_ugarit",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_mot",
			event_message_id = 5752,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_mot_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_mot_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "yahweh",
			localised_name = "phar_local_deities_yahweh",
			localised_flavour = "phar_map_local_deities_yahweh_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_yahweh_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_yahweh.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_yahweh.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_yahweh.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_yahweh.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_yahweh.png",
			culture = "phar_main_clt_canaan",
			epithet = "phar_map_local_deities_epithet_yahweh",
			realms =
			{
				"canaanite_sinai_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_yahweh",
			shrine_chain = "phar_map_ers_shrine_yahweh",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_yahweh",
			cult_centre_region_key = "phar_main_east_sinai_khet_khefti",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_yahweh",
			event_message_id = 5758,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_yahweh_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_yahweh_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_main_hattussa_arinna",
		...
		{
			key = "telipinu",
			localised_name = "phar_local_deities_telipinu",
			localised_flavour = "phar_map_local_deities_telipinu_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_telipinu_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_telipinu.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_telipinu.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_telipinu.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_telipinu.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_telipinu.png",
			culture = "phar_main_clt_hatti",
			epithet = "phar_map_local_deities_epithet_telipinu",
			realms =
			{
				"hittite_isuwa_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_telipinu",
			shrine_chain = "phar_map_ers_shrine_telipinu",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_telipinu",
			cult_centre_region_key = "phar_main_kanesh_kanesh",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_telipinu",
			event_message_id = 5812,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_telipinu_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_telipinu_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "inara",
			localised_name = "phar_local_deities_inara",
			localised_flavour = "phar_map_local_deities_inara_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_inara_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_inara.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_inara.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_inara.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_inara.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_inara.png",
			culture = "phar_main_clt_hatti",
			epithet = "phar_map_local_deities_epithet_inara",
			realms =
			{
				"hittite_isuwa_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_inara",
			shrine_chain = "phar_map_ers_shrine_inara",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_inara",
			cult_centre_region_key = "phar_main_zippalanda_nerik",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_inara",
			event_message_id = 5806,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_inara_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_inara_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		
		{
			...
			cult_centre_region_key = "phar_map_azalzi_shudu",
		...
		{
			key = "hannahanna",
			localised_name = "phar_local_deities_hannahanna",
			localised_flavour = "phar_map_local_deities_hannahanna_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hannahanna_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hannahanna.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hannahanna.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hannahanna.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hannahanna.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hannahanna.png",
			culture = "phar_main_clt_hatti",
			epithet = "phar_map_local_deities_epithet_hannahanna",
			realms =
			{
				"hittite_highlands_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hannahanna",
			shrine_chain = "phar_map_ers_shrine_hannahanna",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hannahanna",
			cult_centre_region_key = "phar_map_zz_tummanna_kinik",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hannahanna",
			event_message_id = 5800,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hannahanna_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hannahanna_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_map_aranzah_nineveh",
		...
		{
			key = "ellil",
			localised_name = "phar_local_deities_ellil",
			localised_flavour = "phar_map_local_deities_ellil_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_ellil_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_ellil.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_ellil.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_ellil.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_ellil.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_ellil.png",
			culture = "phar_map_clt_mesopotamian",
			epithet = "phar_map_local_deities_epithet_ellil",
			realms =
			{
				"mesopotamia_mat_tamti_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_ellil",
			shrine_chain = "phar_map_ers_shrine_ellil",
			dwelling_chain = "phar_map_religion_dwelling_ellil",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_ellil",
			cult_centre_region_key = "phar_map_karduniash_ishtananu_nippur",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_ellil",
			event_message_id = 5830,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_dwelling_t1_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							-- Should be always 0 for dwelling effects as you don't get them for Aten blessings by design!
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_dwelling_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_dwelling_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_dwelling_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_dwelling_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_dwelling_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ellil_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ellil_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "anu",
			localised_name = "phar_local_deities_anu",
			localised_flavour = "phar_map_local_deities_anu_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_anu_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_anu.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_anu.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_anu.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_anu.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_anu.png",
			culture = "phar_map_clt_mesopotamian",
			epithet = "phar_map_local_deities_epithet_anu",
			realms =
			{
				"mesopotamia_mat_tamti_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_anu",
			shrine_chain = "phar_map_ers_shrine_anu",
			dwelling_chain = "phar_map_religion_dwelling_anu",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_anu",
			cult_centre_region_key = "phar_map_karduniash_shutaiu_uruk",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_anu",
			event_message_id = 5818,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_dwelling_t1_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							-- Should be always 0 for dwelling effects as you don't get them for Aten blessings by design!
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_anu_dwelling_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_dwelling_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_anu_dwelling_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_dwelling_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_anu_dwelling_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_anu_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_anu_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "ea",
			localised_name = "phar_local_deities_ea",
			localised_flavour = "phar_map_local_deities_ea_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_ea_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_ea.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_ea.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_ea.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_ea.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_ea.png",
			culture = "phar_map_clt_mesopotamian",
			epithet = "phar_map_local_deities_epithet_ea",
			realms =
			{
				"mesopotamia_mat_tamti_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_ea",
			shrine_chain = "phar_map_ers_shrine_ea",
			dwelling_chain = "phar_map_religion_dwelling_ea",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_ea",
			cult_centre_region_key = "phar_map_karduniash_shutaiu_ur",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_ea",
			event_message_id = 5824,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_dwelling_t1_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							-- Should be always 0 for dwelling effects as you don't get them for Aten blessings by design!
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_ea_dwelling_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_dwelling_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_ea_dwelling_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_dwelling_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_ea_dwelling_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_ea_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_ea_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_map_bit_peri_amurru_agade",
		...
		{
			key = "sin",
			localised_name = "phar_local_deities_sin",
			localised_flavour = "phar_map_local_deities_sin_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_sin_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_sin.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_sin.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_sin.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_sin.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_sin.png",
			culture = "phar_map_clt_mesopotamian",
			epithet = "phar_map_local_deities_epithet_sin",
			realms =
			{
				"mesopotamia_mat_tamti_realm",
				"canaanite_yamhad_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_sin",
			shrine_chain = "phar_map_ers_shrine_sin",
			dwelling_chain = "phar_map_religion_dwelling_sin",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_sin",
			cult_centre_region_key = "phar_map_karduniash_shutaiu_ur",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_sin",
			event_message_id = 5842,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_dwelling_t1_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							-- Should be always 0 for dwelling effects as you don't get them for Aten blessings by design!
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_sin_dwelling_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_dwelling_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_sin_dwelling_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_dwelling_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_sin_dwelling_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_sin_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_sin_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "shamash",
			localised_name = "phar_local_deities_shamash",
			localised_flavour = "phar_map_local_deities_shamash_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_shamash_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_shamash.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_shamash.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_shamash.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_shamash.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_shamash.png",
			culture = "phar_map_clt_mesopotamian",
			epithet = "phar_map_local_deities_epithet_shamash",
			realms =
			{
				"mesopotamia_mat_tamti_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_shamash",
			shrine_chain = "phar_map_ers_shrine_shamash",
			dwelling_chain = "phar_map_religion_dwelling_shamash",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_shamash",
			cult_centre_region_key = "phar_map_suhum_shaplu_sippar_amnamun",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_shamash",
			event_message_id = 5836,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_dwelling_t1_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							-- Should be always 0 for dwelling effects as you don't get them for Aten blessings by design!
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_dwelling_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_dwelling_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_dwelling_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_dwelling_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_dwelling_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_shamash_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_shamash_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		--### Aegean Gods ###
		{
			...
			cult_centre_region_key = "phar_map_lacedaemon_altis",
		...
		{
			key = "hera",
			localised_name = "phar_local_deities_hera",
			localised_flavour = "phar_map_local_deities_hera_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hera_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hera.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hera.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hera.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hera.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hera.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_hera",
			realms =
			{
				"aegean_achaea_realm",
				"aegean_assuwa_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hera",
			shrine_chain = "phar_map_ers_shrine_hera",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hera",
			cult_centre_region_key = "phar_map_mycenaeca_mycenae",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hera",
			event_message_id = 5722,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hera_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hera_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		
		{
			...
			cult_centre_region_key = "phar_map_mycenaeca_corinth",
		...
		{
			key = "athena",
			localised_name = "phar_local_deities_athena",
			localised_flavour = "phar_map_local_deities_athena_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_athena_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_athena.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_athena.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_athena.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_athena.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_athena.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_athena",
			realms =
			{
				"aegean_achaea_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_athena",
			shrine_chain = "phar_map_ers_shrine_athena",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_athena",
			cult_centre_region_key = "phar_map_attica_athens",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_athena",
			event_message_id = 5692,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_athena_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_athena_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_map_boeotia_cyparissos",
        ...
        {
			key = "artemis",
			localised_name = "phar_local_deities_artemis",
			localised_flavour = "phar_map_local_deities_artemis_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_artemis_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_artemis.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_artemis.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_artemis.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_artemis.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_artemis.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_artemis",
			realms =
			{
				"aegean_assuwa_realm",
				"aegean_achaea_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_artemis",
			shrine_chain = "phar_map_ers_shrine_artemis",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_artemis",
			cult_centre_region_key = "phar_map_maeonia_ephesos",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_artemis",
			event_message_id = 5686,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_artemis_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_artemis_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
...

		{
			...
			cult_centre_region_key = "phar_map_themiscyra_zalpa",
...

		{
			...
			cult_centre_region_key = "phar_map_lacedaemon_cythera",
		...
		{
			key = "hephaestus",
			localised_name = "phar_local_deities_hephaestus",
			localised_flavour = "phar_map_local_deities_hephaestus_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hephaestus_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hephaestus.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hephaestus.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hephaestus.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hephaestus.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hephaestus.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_hephaestus",
			realms =
			{
				"aegean_assuwa_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hephaestus",
			shrine_chain = "phar_map_ers_shrine_hephaestus",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hephaestus",
			cult_centre_region_key = "phar_map_zerynthia_nesoi_myrina",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hephaestus",
			event_message_id = 5716,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hephaestus_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hephaestus_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "hermes",
			localised_name = "phar_local_deities_hermes",
			localised_flavour = "phar_map_local_deities_hermes_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hermes_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hermes.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hermes.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hermes.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hermes.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hermes.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_hermes",
			realms =
			{
				"aegean_achaea_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hermes",
			shrine_chain = "phar_map_ers_shrine_hermes",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hermes",
			cult_centre_region_key = "phar_map_mycenaeca_aegion",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hermes",
			event_message_id = 5728,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hermes_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hermes_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "demeter",
			localised_name = "phar_local_deities_demeter",
			localised_flavour = "phar_map_local_deities_demeter_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_demeter_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_demeter.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_demeter.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_demeter.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_demeter.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_demeter.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_demeter",
			realms =
			{
				"hittite_highlands_realm",
				"aegean_achaea_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_demeter",
			shrine_chain = "phar_map_ers_shrine_demeter",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_demeter",
			cult_centre_region_key = "phar_main_west_hatti_gordion",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_demeter",
			event_message_id = 5698,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_demeter_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_demeter_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "hestia",
			localised_name = "phar_local_deities_hestia",
			localised_flavour = "phar_map_local_deities_hestia_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hestia_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hestia.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hestia.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hestia.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hestia.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hestia.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_hestia",
			realms =
			{
				"aegean_achaea_realm",
				"aegean_assuwa_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hestia",
			shrine_chain = "phar_map_ers_shrine_hestia",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hestia",
			cult_centre_region_key = "phar_map_lacedaemon_altis",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hestia",
			event_message_id = 5734,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hestia_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hestia_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "dionysus",
			localised_name = "phar_local_deities_dionysus",
			localised_flavour = "phar_map_local_deities_dionysus_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_dionysus_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_dionysus.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_dionysus.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_dionysus.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_dionysus.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_dionysus.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_dionysus",
			realms =
			{
				"aegean_achaea_realm",
				"aegean_thrace_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_dionysus",
			shrine_chain = "phar_map_ers_shrine_dionysus",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_dionysus",
			cult_centre_region_key = "phar_map_boeotia_thebes",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_dionysus",
			event_message_id = 5704,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_dionysus_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_dionysus_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "hades",
			localised_name = "phar_local_deities_hades",
			localised_flavour = "phar_map_local_deities_hades_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_hades_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_hades.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hades.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_hades.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_hades.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_hades.png",
			culture = "phar_map_clt_aegean",
			epithet = "phar_map_local_deities_epithet_hades",
			realms =
			{
				"aegean_achaea_realm",
			},
			temple_chain = "phar_map_religion_temple_aegean_hades",
			shrine_chain = "phar_map_ers_shrine_hades",
			dwelling_chain = "",
			idol_chain = "",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_hades",
			cult_centre_region_key = "phar_map_macedonia_cassope",
			cult_centre_chain = "phar_map_religion_cult_center_grand_temple_hades",
			event_message_id = 5710,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_hades_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_hades_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
		...
		{
			key = "typhon",
			localised_name = "phar_local_deities_typhon",
			localised_flavour = "phar_map_local_deities_typhon_description_discovered",
			localised_undiscovered_flavour = "phar_map_local_deities_typhon_description_undiscovered",
			tab_image = "UI/skins/default/local_deities/portraits/listview/portrait_listview_map_god_greek_typhon.png",
			tab_image_small = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_typhon.png",
			god_slot_image = "UI/skins/default/local_deities/portraits/tab_small/portrait_tab_small_map_god_greek_typhon.png",
			main_image = "UI/skins/default/local_deities/portraits/main/portrait_map_god_greek_typhon.png",
			round_portrait = "UI/skins/default/local_deities/portraits/round/portrait_round_map_god_greek_typhon.png",
			culture = "phar_main_clt_sea_peoples",
			epithet = "phar_map_local_deities_epithet_typhon",
			realms = {
				-- no realms for Typhon
			},
			temple_chain = "phar_map_religion_temple_aegean_typhon",
			shrine_chain = "phar_map_ers_shrine_typhon",
			dwelling_chain = "",
			idol_chain = "phar_sea_religion_idol_typhon",
			prayer_effect_bundle = "phar_map_effect_bundle_local_deities_activate_prayer_typhon",
			cult_centre_region_key = "",	-- no cult centres for Typhon
			cult_centre_chain = "",
			event_message_id = 5848,
			tiers = 
			{
				-- Tier 1
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t1_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t1_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t1_effect_02",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t1_effect_03",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t1_effect_04",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t1_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 2
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t2_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t2_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t2_effect_02",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t2_effect_03",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t2_effect_04",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t2_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_army_t1_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_army_t1_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_army_t1_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
				...
				-- Tier 3
				{
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_shrine_t3_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_province_2_desc",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t3_effect_01",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t3_effect_02",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t3_effect_03",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t3_effect_04",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
						{
							bundle = "phar_sea_effect_bundle_typhon_shrine_t3_effect_05",
							localised_flavour = "phar_local_deities_god_description_text",
							aten_unlockable_random_weight = 0,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t3_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_1_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t3_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_prayer_t3_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_campaign_2_desc",
							aten_unlockable_random_weight = 10,
						},
					},
					...
					{
						{
							bundle = "phar_map_effect_bundle_typhon_army_t2_effect_01",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_combat_stats_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_army_t2_effect_02",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
						{
							bundle = "phar_map_effect_bundle_typhon_army_t2_effect_03",
							localised_flavour = "phar_main_al_akhenaten_stolen_effects_morale_desc",
							aten_unlockable_random_weight = 10,
						},
					},
	...
	human_gods =
	{
		...
		phar_main_suppiluliuma = "tarhunz",
		...
		troy_main_dan_achilles = "zeus",
		troy_main_dan_ithaca = "hermes",
		troy_main_trj_lycia = "zeus",
		troy_rem_trj_thrace = "dionysus",
		troy_main_dan_boeotians = "dionysus",
		phar_main_ugarit = "el",
		...
		phar_main_malidiya = "kurunta",
		troy_amazons_trj_hippolyta = "ares",
		...
		--Added for mod
		phar_main_abdju = "ra",
		troy_main_dan_abantes = "zeus",
		phar_main_aleppo = "baal",
		phar_main_amurru = "baal",
		phar_main_ancyra = "arinna",
		phar_main_ascanian_phrygia = "arinna",
		troy_main_dan_aethaleia = "apollo",
		phar_main_buhen = "ra",
		phar_main_buto = "ra",
		phar_main_dakhla = "osiris",
		troy_main_dan_anemoessa = "poseidon",
		phar_main_faiyum = "ptah",
		phar_main_farafra = "marduk",
		phar_main_hazor = "baal",
		phar_main_het_nesut = "ptah",
		phar_main_hetch = "ptah",
		phar_main_hubishna = "aphrodite",
		phar_main_kanesh = "tarhunz",
		phar_main_kawa = "horus",
		phar_main_kerma = "isis",
		phar_main_kharga = "horus",
		phar_main_khemenu = "thoth",
		phar_main_kizzuwatna = "arinna",
		phar_main_kurkur = "baal",
		phar_main_larawanda = "arinna",
		phar_main_manyan_phrygia = "arinna",
		phar_main_megiddo = "el",
		phar_main_mes = "osiris",
		phar_main_meshwesh = "osiris",
		phar_main_miam = "set",
		troy_main_dan_antheada = "aphrodite",
		phar_main_nubt = "ra",
		phar_main_paphos = "baal",
		phar_main_parha = "arinna",
		phar_main_per_amun = "amun",
		phar_main_pi_ramesses = "ra",
		phar_main_purushanda = "kurunta",
		phar_main_rhacotis = "ra",
		phar_main_sakka = "moloch",
		phar_main_sapinuwa = "kurunta",
		phar_main_schechem = "moloch",
		phar_main_saww = "isis",
		phar_main_sukhot = "ra",
		phar_main_timna = "thoth",
		phar_main_tuwana = "ra",
		phar_main_urushalim = "moloch",
		phar_main_waset = "ra",
		phar_main_zawty = "set",
		phar_map_alum = "ishtar",
		phar_map_duranki = "ninurta",
		phar_map_ekurma = "marduk",
		phar_map_gasham = "marduk",
		phar_map_guedena = "inshushinak",
		phar_map_gutium = "ashur",
		phar_map_hurru = "ishtar",
		troy_main_dan_apaesos = "apollo",
		phar_map_ishtaran = "ishtar",
		phar_map_kare = "ashur",
		phar_map_kengir = "inshushinak",
		phar_map_kingu = "marduk",
		phar_map_kirata = "ishtar",
		phar_map_kishu = "ninurta",
		troy_main_dan_arcadians = "zeus",
		phar_map_maeonians = "aphrodite",
		phar_map_maita = "ninurta",
		phar_map_mari = "ishtar",
		phar_map_namar = "marduk",
		phar_map_nidr = "ishtar",
		phar_map_nirbu = "ashur",
		phar_map_nudimat = "ninurta",
		phar_map_pala = "arinna",
		phar_map_quiha = "kumarbi",
		troy_main_dan_athina = "athena",
		troy_main_dan_cassopaei = "zeus",
		phar_map_shutrukid = "inshushinak",
		phar_map_suhu = "ashur",
		troy_main_dan_chersonesos = "apollo",
		phar_map_tehenou = "horus",
        phar_map_teisheba = "marduk",
		phar_map_temen = "ninurta",
		phar_map_ur = "marduk",
		phar_map_urumu = "ishtar",
		phar_map_utu = "ninurta",
		phar_map_weila = "ashur",
		phar_sea_lukka = "levs",
		troy_main_dan_corinthians = "poseidon",
		troy_main_dan_curetes = "zeus",
		troy_main_dan_dionysias = "dionysus",
		troy_main_dan_dolopia = "ares",
		troy_main_dan_ephesos = "aphrodite",
		troy_main_dan_knossos = "poseidon",
		troy_main_dan_kyme = "apollo",
		troy_main_dan_magnetes = "ares",
        troy_main_dan_makaria = "apollo",
		troy_main_dan_miletus = "aphrodite",
		troy_main_dan_phlegra = "ares",
		troy_main_dan_pylos = "zeus",
		troy_main_dan_rhodes = "aphrodite",
		troy_main_dan_teleboans = "poseidon",
		troy_main_dan_triopion = "aphrodite",
		troy_main_dan_vehinda = "arinna",
		troy_main_trj_apsynthioi = "apollo",
		troy_main_trj_bithyni = "apollo",
		troy_main_trj_carians = "aphrodite",
		troy_main_trj_cicones = "ares",
        troy_main_trj_lelegia_min = "poseidon",
		troy_main_trj_paeonians = "ares",
		troy_main_trj_paphlagonians = "arinna",
		troy_main_trj_pelasgiotes = "apollo",
		troy_main_trj_tereia = "aphrodite",
		troy_main_trj_thrakes = "dionysus",
		troy_main_trj_thyni = "ares",
		troy_main_trj_tlawa = "aphrodite",
	},
					...
					if curr_faction:culture() == sea_peoples_culture_key then
						...
						for _, god_data in ipairs(deities.gods) do
							if god_data.culture == sea_peoples_culture_key then
                                --Changed for mod
								if god_data.key ~= "typhon" or not modular_difficulty_campaign.variables.discover_typhon then
			...
			for i = 1, #deities.component_ids.tab_buttons do
				...
				if tab_component then
					...
					elseif deities.component_ids.tab_buttons[i] == "sea_peoples_tab_button" then
                        --Changed for mod
						tab_parent:SetVisible(deities.faction_has_access_to_idols(faction_key) or is_typhon_discovered)
					end
		...
		for i = 1, #deities.component_ids.culture_tabs do
			...
			if current_tab_content_component then
				...
				if (i == 1 and not deities.has_faction_claimed_akhenaten(faction_key))
					...
					and not deities.faction_has_access_to_idols(faction_key) and not is_typhon_discovered)
				then
	...
	fill_create_aten_gods = function()
		...
		if #discovered_gods > 0 then
			...
			for i, god_key in ipairs(discovered_gods) do
				...
				local god = deities.get_god(god_key)
				--Changed for mod
				if god and (not deities.is_sea_god(god_key) or god_key == "typhon") then
					local cco_god_table = {}
