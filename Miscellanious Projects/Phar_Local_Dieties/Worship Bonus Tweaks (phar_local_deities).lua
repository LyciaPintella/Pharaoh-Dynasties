...
deities = {
     ...
     config = {
          ...
          favour_tiers = {0, 300, 800, 950, 1150, 1400, 1700},
          ...
          pray_interaction_prefixes = {"phar_ers_interaction_shrine_pray_", "phar_ers_interaction_idol_pray_"},
          ...
          technologies = {"phar_main_tech_economic_6_god_slot_2", "phar_main_tech_economic_10_god_slot_3"},

          -- List of cultures, currently used for displaying possible gods for creating Aten
          cultures = {
               "phar_main_clt_kemets", "phar_main_clt_canaan", "phar_main_clt_hatti", "phar_main_clt_sea_peoples", "phar_map_clt_mesopotamian", "phar_map_clt_aegean"
          },
          ...
          cultures_with_hecatomb = {"phar_map_clt_aegean"},

          -- Hecatomb costs for unlocking tier 2 and tier 3
          hecatomb_costs = {"phar_map_hecatomb_tier_1", "phar_map_hecatomb_tier_2", "phar_map_hecatomb_tier_3"},
     ...
     gods = {
          -- ###Egyptian Gods###
          {
               ...
               realms = {"egyptian_lower_egypt_realm", "canaanite_sinai_realm"},
               ...
               realms = {"egyptian_kush_realm", "egyptian_western_desert_realm"},
               ...
               realms = {"egyptian_kush_realm", "egyptian_nubia_realm"},
               ...
               realms = {"egyptian_upper_egypt_realm", "egyptian_nubia_realm"},
               ...
               realms = {"egyptian_western_desert_realm", "egyptian_upper_egypt_realm"},
               ...
               realms = {"egyptian_lower_egypt_realm"},
          ...
          }, -- ### Canaanite Gods ###
          {
               ...
               realms = {"canaanite_retjenu_realm", "canaanite_yamhad_realm"},
               ...
               realms = {"canaanite_fenkhu_realm", "canaanite_yamhad_realm"},
               ...
               realms = {"canaanite_retjenu_realm", "canaanite_fenkhu_realm"},
               ...
               realms = {"canaanite_fenkhu_realm", "canaanite_sinai_realm"},
          ...
          }, -- ### Hittite Gods ###
          {
               ...
               realms = {"canaanite_yamhad_realm", "hittite_isuwa_realm"},
               ...
               realms = {"hittite_isuwa_realm", "hittite_lowlands_realm"},
               ...
               realms = {"hittite_lowlands_realm", "hittite_highlands_realm"},
               ...
               realms = {"hittite_highlands_realm", "hittite_lowlands_realm", "aegean_assuwa_realm"},
               ...
               realms = {"hittite_highlands_realm", "hittite_isuwa_realm"},
          ...
          }, -- ### Mesopotamian Gods ###
          {
               ...
               realms = {"mesopotamia_aber_nahra_realm", "mesopotamia_mat_assur_realm", "mesopotamia_zagros_realm"},
               ...
               realms = {"mesopotamia_aber_nahra_realm", "mesopotamia_mat_assur_realm", "mesopotamia_zagros_realm", "mesopotamia_haltamti_realm"},
               ...
               realms = {"mesopotamia_mat_tamti_realm", "mesopotamia_haltamti_realm"},
               ...
               realms = {"mesopotamia_mat_tamti_realm", "mesopotamia_haltamti_realm", "mesopotamia_zagros_realm"},
               ...
               realms = {"mesopotamia_mat_tamti_realm", "mesopotamia_aber_nahra_realm", "mesopotamia_mat_assur_realm"},
          ...
          }, -- ### Aegean Gods ###
          {
               ...
               realms = {"aegean_achaea_realm", "aegean_thrace_realm"},
               ...
               realms = {"aegean_assuwa_realm", "aegean_thrace_realm"},
     ...
     auto_discoverable_gods = {phar_sea_sherden = {"alpanu", "isul", "larun"}, phar_sea_peleset = {"kuvava", "levs", "alpanu"}},

     -- Configuration for gods worshipped by AI
     ai_gods = {
          -- Major Deities worshipped by AI
          phar_main_ramesses = {{god_key = "ra", starting_favour = 240}},

          phar_main_seti = {{god_key = "set", starting_favour = 240}},
          phar_main_tausret = {{god_key = "isis", starting_favour = 240}},
          phar_main_amenmesse = {{god_key = "amun", starting_favour = 240}},
          phar_main_bay = {{god_key = "thoth", starting_favour = 240}},
          phar_main_kurunta = {{god_key = "kurunta", starting_favour = 240}},
          phar_main_irsu = {{god_key = "moloch", starting_favour = 240}},
          phar_main_suppiluliuma = {{god_key = "arinna", starting_favour = 240}},
          phar_main_merneptah = {{god_key = "ptah", starting_favour = 0}},
          phar_sea_sherden = {{god_key = "isul", starting_favour = 240}},
          phar_sea_peleset = {{god_key = "kuvava", starting_favour = 240}},
          troy_main_dan_mycenae = {{god_key = "zeus", starting_favour = 240}},
          troy_main_trj_troy = {{god_key = "apollo", starting_favour = 240}},
          phar_map_babylon = {{god_key = "marduk", starting_favour = 240}},
          phar_map_ninurta = {{god_key = "ninurta", starting_favour = 240}},

          -- Minor Factions worshipped by AI
          phar_main_dakhla = {{god_key = "osiris", starting_favour = 50}},
          phar_main_kharga = {{god_key = "horus", starting_favour = 20}},
          phar_main_dungul = {{god_key = "amun", starting_favour = 150}},
          phar_main_kerma = {{god_key = "isis", starting_favour = 50}},
          phar_main_khet_pa = {{god_key = "anubis", starting_favour = 30}},
          phar_main_kawa = {{god_key = "horus", starting_favour = 150}},
          phar_main_miam = {{god_key = "set", starting_favour = 20}},
          phar_main_waset = {{god_key = "amun", starting_favour = 50}},
          phar_main_zawty = {{god_key = "set", starting_favour = 50}},
          phar_main_mes = {{god_key = "osiris", starting_favour = 80}},
          phar_main_setnakhte = {{god_key = "set", starting_favour = 150}},
          phar_main_faiyum = {{god_key = "ptah", starting_favour = 150}},
          phar_main_buto = {{god_key = "ra", starting_favour = 50}},
          phar_main_khemenu = {{god_key = "thoth", starting_favour = 50}},
          phar_main_ashkelon = {{god_key = "yamm", starting_favour = 150}},
          phar_main_hetch = {{god_key = "ptah", starting_favour = 50}},
          phar_main_beersheba = {{god_key = "ra", starting_favour = 50}},
          phar_main_sakka = {{god_key = "moloch", starting_favour = 50}},
          phar_main_emar = {{god_key = "asherah", starting_favour = 150}},
          phar_main_damascus = {{god_key = "baal", starting_favour = 100}},
          phar_main_amurru = {{god_key = "el", starting_favour = 100}},
          phar_main_megiddo = {{god_key = "el", starting_favour = 50}},
          phar_main_carchemish = {{god_key = "baal", starting_favour = 100}},
          phar_main_kanesh = {{god_key = "tarhunz", starting_favour = 100}},
          phar_main_kummanni = {{god_key = "kumarbi", starting_favour = 50}},
          phar_main_ancyra = {{god_key = "arinna", starting_favour = 150}},
          phar_main_cibyra = {{god_key = "kurunta", starting_favour = 50}},
          phar_main_tuwana = {{god_key = "shaushka", starting_favour = 100}},
          phar_main_kizzuwatna = {{god_key = "arinna", starting_favour = 50}},
          phar_sea_denyen = {
               {
          ...
          phar_sea_lukka = {{god_key = "levs", starting_favour = 50}},
          phar_sea_teresh = {{god_key = "levs", starting_favour = 50}},
          phar_sea_tjeker = {{god_key = "levs", starting_favour = 50}},
          phar_sea_shekelesh = {{god_key = "larun", starting_favour = 50}},
          phar_map_alum = {{god_key = "ishtar", starting_favour = 50}},
          phar_map_assyria = {{god_key = "ashur", starting_favour = 150}},
          phar_map_bit_zamani = {{god_key = "ninurta", starting_favour = 30}},
          phar_map_duranki = {{god_key = "ninurta", starting_favour = 150}},
          phar_map_ekurma = {{god_key = "marduk", starting_favour = 50}},
          phar_map_gasham = {{god_key = "marduk", starting_favour = 50}},
          phar_map_guedena = {{god_key = "inshushinak", starting_favour = 50}},
          phar_map_gutium = {{god_key = "ashur", starting_favour = 30}},
          phar_map_hurru = {{god_key = "ishtar", starting_favour = 70}},
          phar_map_igihalkid = {{god_key = "inshushinak", starting_favour = 150}},
          phar_map_ishtaran = {{god_key = "ninurta", starting_favour = 20}},
          phar_map_kare = {{god_key = "ashur", starting_favour = 30}},
          phar_map_kengir = {{god_key = "inshushinak", starting_favour = 20}},
          phar_map_kingu = {{god_key = "marduk", starting_favour = 30}},
          phar_map_kirata = {{god_key = "ishtar", starting_favour = 30}},
          phar_map_kishu = {{god_key = "ninurta", starting_favour = 50}},
          phar_map_kurbarnuna = {{god_key = "ishtar", starting_favour = 150}},
          phar_map_lullubi = {{god_key = "ashur", starting_favour = 50}},
          phar_map_maeonians = {{god_key = "aphrodite", starting_favour = 50}},
          phar_map_maita = {{god_key = "ninurta", starting_favour = 20}},
          phar_map_mari = {{god_key = "ishtar", starting_favour = 30}},
          phar_map_namar = {{god_key = "marduk", starting_favour = 30}},
          phar_map_nidr = {{god_key = "ishtar", starting_favour = 50}},
          phar_map_nirbu = {{god_key = "ashur", starting_favour = 30}},
          phar_map_nudimat = {{god_key = "ninurta", starting_favour = 30}},
          phar_map_pala = {{god_key = "arinna", starting_favour = 50}},
          phar_map_quiha = {{god_key = "kumarbi", starting_favour = 20}},
          phar_map_sangarian_phrygians = {{god_key = "arinna", starting_favour = 50}},
          phar_map_shubru = {{god_key = "kumarbi", starting_favour = 20}},
          phar_map_shutrukid = {{god_key = "inshushinak", starting_favour = 50}},
          phar_map_suhu = {{god_key = "ashur", starting_favour = 30}},
          phar_map_sutu = {{god_key = "ishtar", starting_favour = 50}},
          phar_map_tehenou = {{god_key = "horus", starting_favour = 20}},
          phar_map_teisheba = {{god_key = "marduk", starting_favour = 20}},
          phar_map_temen = {{god_key = "ninurta", starting_favour = 30}},
          phar_map_ur = {{god_key = "marduk", starting_favour = 50}},
          phar_map_urumu = {{god_key = "ishtar", starting_favour = 20}},
          phar_map_utu = {{god_key = "ninurta", starting_favour = 20}},
          phar_map_weila = {{god_key = "ashur", starting_favour = 30}},
          troy_amazons_trj_hippolyta = {{god_key = "tarhunz", starting_favour = 30}},
          troy_main_dan_abantes = {{god_key = "zeus", starting_favour = 30}},
          troy_main_dan_achilles = {{god_key = "zeus", starting_favour = 50}},
          troy_main_dan_aethaleia = {{god_key = "apollo", starting_favour = 30}},
          troy_main_dan_aetolians = {{god_key = "ares", starting_favour = 20}},
          troy_main_dan_anemoessa = {{god_key = "poseidon", starting_favour = 50}},
          troy_main_dan_antheada = {{god_key = "aphrodite", starting_favour = 30}},
          troy_main_dan_apaesos = {{god_key = "apollo", starting_favour = 20}},
          troy_main_dan_arcadians = {{god_key = "zeus", starting_favour = 30}},
          troy_main_dan_athina = {{god_key = "poseidon", starting_favour = 50}},
          troy_main_dan_boeotians = {{god_key = "zeus", starting_favour = 50}},
          troy_main_dan_cassopaei = {{god_key = "zeus", starting_favour = 30}},
          troy_main_dan_chersonesos = {{god_key = "apollo", starting_favour = 20}},
          troy_main_dan_corinthians = {{god_key = "poseidon", starting_favour = 30}},
          troy_main_dan_curetes = {{god_key = "zeus", starting_favour = 20}},
          troy_main_dan_dionysias = {{god_key = "poseidon", starting_favour = 50}},
          troy_main_dan_dolopia = {{god_key = "ares", starting_favour = 30}},
          troy_main_dan_dolopians = {{god_key = "aphrodite", starting_favour = 20}},
          troy_main_dan_ephesos = {{god_key = "aphrodite", starting_favour = 50}},
          troy_main_dan_ithaca = {{god_key = "poseidon", starting_favour = 50}},
          troy_main_dan_knossos = {{god_key = "poseidon", starting_favour = 150}},
          troy_main_dan_kyme = {{god_key = "apollo", starting_favour = 50}},
          troy_main_dan_magnetes = {{god_key = "ares", starting_favour = 20}},
          troy_main_dan_makaria = {{god_key = "apollo", starting_favour = 30}},
          troy_main_dan_miletus = {{god_key = "aphrodite", starting_favour = 50}},
          troy_main_dan_phlegra = {{god_key = "ares", starting_favour = 30}},
          troy_main_dan_pylos = {{god_key = "zeus", starting_favour = 30}},
          troy_main_dan_rhodes = {{god_key = "aphrodite", starting_favour = 50}},
          troy_main_dan_teleboans = {{god_key = "poseidon", starting_favour = 20}},
          troy_main_dan_triopion = {{god_key = "aphrodite", starting_favour = 50}},
          troy_main_dan_vehinda = {{god_key = "arinna", starting_favour = 20}},
          troy_main_trj_apsynthioi = {{god_key = "apollo", starting_favour = 30}},
          troy_main_trj_bithyni = {{god_key = "apollo", starting_favour = 50}},
          troy_main_trj_carians = {{god_key = "aphrodite", starting_favour = 150}},
          troy_main_trj_cicones = {{god_key = "ares", starting_favour = 50}},
          troy_main_trj_ilion = {{god_key = "apollo", starting_favour = 20}},
          troy_main_trj_lelegia_min = {{god_key = "poseidon", starting_favour = 30}},
          troy_main_trj_lycia = {{god_key = "aphrodite", starting_favour = 50}},
          troy_main_trj_paeonians = {{god_key = "ares", starting_favour = 50}},
          troy_main_trj_paphlagonians = {{god_key = "arinna", starting_favour = 50}},
          troy_main_trj_pelasgiotes = {{god_key = "apollo", starting_favour = 30}},
          troy_main_trj_tereia = {{god_key = "aphrodite", starting_favour = 20}},
          troy_main_trj_thrakes = {{god_key = "apollo", starting_favour = 20}},
          troy_main_trj_thyni = {{god_key = "ares", starting_favour = 30}},
          troy_main_trj_tlawa = {{god_key = "aphrodite", starting_favour = 20}},
          troy_rem_trj_thrace = {{god_key = "ares", starting_favour = 150}}
     },
     ...
     component_ids = {
          ...
          tab_buttons = {
               "aten_tab_button", "egyptian_tab_button", "canaanites_tab_button", "hittites_tab_button", "sea_peoples_tab_button", "mesopotamian_tab_button",
               "greek_tab_button"
          },

          gods_list = "gods_list",
          culture_tabs = {
               "aten_tab_content", "egyptian_tab_content", "canaan_tab_content", "hittite_tab_content", "sea_peoples_tab_content", "mesopotamian_tab_content",
               "greek_tab_content"
          },
          ...
          hecatomb_decorations = {"bulls_decoration", "bulls_decoration2"},

          tier_icon_component_names = {"tier_1", "tier_2", "tier_3"},

          tier_unlock_warnings = {"shrines_alert_text", "idols_alert_text", "prayer_alert_text", "army_alert_text", "dwelling_alert_text"},
     ...
     text_ids = {
          tiers = {
               "phar_local_deities_favour_income_tier_1", "phar_local_deities_favour_income_tier_2", "phar_local_deities_favour_income_tier_3",
               "phar_local_deities_favour_income_tier_4", "phar_local_deities_favour_income_tier_5", "phar_local_deities_favour_income_tier_6",
     ...
     script_ids = {favoured_god_table_script_id = "local_deities_favoured_god_info"},
     ...
     -- saved data for UI
     ui_persistent = {newly_discovered_gods = {}},
     ...
     inactive_building_template = {god_key = nil, data = {}},
     ...
     religious_building_types = {shrine = "shrine", temple = "temple", dwelling = "dwelling", idol = "idol"},
     ...
     output = function(str, priority)
          ...
          if deities.config.min_priority_to_print > 0 then if not priority or deities.config.min_priority_to_print > priority then return end end

          out("*** _LOCAL_DEITIES_ ***: " .. str)
     end,

     get_god = function(key) return table_find(deities.gods, function(e) return e.key == key end) end,

     get_favoured_god = function(faction_key)
          local legitimacy_path = legitimacy_choice:get_unlocked_legitimacy(faction_key)
          if not legitimacy_path then return end
     ...
     god_requires_hecatomb = function(key)
          ...
          if not god then return false end
     ...
     init_aten_slot = function(slot)
          ...
          for i = 1, #deities.config.favour_tiers do table.insert(slot.tiers, table_deep_copy(aten_effects_template)) end
     ...
     get_gods_from_culture = function(culture)
          local result = {}
          for _, god_data in ipairs(deities.gods) do if god_data.culture == culture then table.insert(result, god_data) end end
          return result
     end,
     ...
     get_filtered_gods_from_culture = function(culture, faction_key, worshipped, discovered)
          ...
          for _, god_data in ipairs(deities.gods) do
               if god_data.culture == culture then
                    ...
                    local show_god = true
                    if is_table(deities.auto_discoverable_gods[faction_key]) and table_find(deities.auto_discoverable_gods[faction_key], god_data.key) then
                         show_god = true
                    else
                    ...
                    if show_god then
                         ...
                         if current_worshipped == worshipped and current_discovered == discovered then table.insert(result, god_data) end
                    end
               end
          end
          return result
     ...
     get_god_temple_chain = function(key) return deities.get_god(key).temple_chain end,

     get_god_shrine_chain = function(key) return deities.get_god(key).shrine_chain end,

     get_god_dwelling_chain = function(key) return deities.get_god(key).dwelling_chain end,

     get_god_idol_chain = function(key) return deities.get_god(key).idol_chain end,

     get_god_data_for_shrine_chain = function(building_chain_key)
          if not building_chain_key or building_chain_key == "" then return nil end
          for _, god_data in ipairs(deities.gods) do if god_data.shrine_chain == building_chain_key then return god_data end end
          return nil
     end,
     ...
     get_god_shrine_effects = function(faction_key, god_key)
          ...
          if not is_table(tiers) then return nil end
     ...
     get_shrine_effects = function(faction_key, building_chain_key)
          ...
          if not god_data then return nil end
     ...
     get_god_data_for_dwelling_chain = function(building_chain_key)
          if not building_chain_key or building_chain_key == "" then return nil end
          for _, god_data in ipairs(deities.gods) do if god_data.dwelling_chain == building_chain_key then return god_data end end
          return nil
     end,
     ...
     get_god_data_for_idol_chain = function(building_chain_key)
          if not building_chain_key or building_chain_key == "" then return nil end
          for _, god_data in ipairs(deities.gods) do if god_data.idol_chain == building_chain_key then return god_data end end
          return nil
     end,
     ...
     get_god_cult_centre_chain = function(key) return deities.get_god(key).cult_centre_chain end,

     get_god_cult_centre_region = function(key) return deities.get_god(key).cult_centre_region_key end,
     ...
     get_god_slot = function(faction_key, god_key)
          ...
          if not god_key then return nil end
     ...
     get_god_event_message_id = function(key) return deities.get_god(key).event_message_id or 0 end,
     ...
     has_faction_discovered_god = function(faction_key, god_key)
          ...
          if god_key == deities.config.aten_god_key then return deities.has_faction_claimed_akhenaten(faction_key) end
     ...
     get_faction_god_slots_count = function(faction_key)
          if deities.has_faction_created_aten(faction_key) then return 1 end
          ...
          if is_number(bonus_slots_unlocked) then
               ...
               if slot_number > #god_slots then slot_number = #god_slots end
               return slot_number
          else
     ...
     get_faction_prayer_duration = function(faction_key, god_key, force)
          ...
          if is_number(bonus_prayer_duration_for_faction) then base_prayer_duration = base_prayer_duration + bonus_prayer_duration_for_faction end
          if is_number(bonus_prayer_duration_for_character) then base_prayer_duration = base_prayer_duration + bonus_prayer_duration_for_character end

          return base_prayer_duration
     end,

     has_faction_god_slot_available = function(faction_name)
          if not feature_unlock.is_feature_unlocked_for_faction(faction_name, feature_ids_config.local_deities) then return false end
          ...
          for i = 1, deities.get_faction_god_slots_count(faction_name) do
               ...
               if god_slot and not god_slot.god_key then return true end
          end
          return false
     end,
     ...
     add_deities_event_message = function(...)
          ...
          if is_feature_unlocked then cm:add_event_feed_event(unpack(arg)) end
     end,
     ...
     is_using_shrines_or_idols = function(faction_key, god_key)
          ...
          local tiers = deities.get_god_tiers(faction_key, god_key)
          if not is_table(tiers) then return result end
     ...
     add_shrine = function(faction_key, god_key, region_key)
          ...
          if not is_table(deities.persistent[faction_key]) then return end
          ...
          if deities.get_inactive_shrine_in_region(faction_key, region_key) then
               ...
               if bonus_value_foreign_shrine_converted_gold > 0 then
                    ...
                    resource_cost_object:add_resource_cost("troy_gold", deities.config.resource_factor_gold_from_foreign_convesion,
                                                           bonus_value_foreign_shrine_converted_gold)
          ...
          local tier = deities.get_tier(faction_key, god_key)
          local tiers = deities.get_god_tiers(faction_key, god_key)
          if not is_table(tiers) then return end
     ...
     remove_shrine = function(faction_key, god_key, region_key)
          ...
          if current_tier ~= -1 then
               ...
               for i = 1, #deities.config.favour_tiers do deities.remove_shrine_effects_for_tier(faction_key, god_key, region_key, i) end
          end
     ...
     remove_shrine_effects_for_tier = function(faction_key, god_key, region_key, tier)
          local tiers = deities.get_god_tiers(faction_key, god_key)
          if not is_table(tiers) or tier > #tiers then return end

          local shrine_effect_bundles = tiers[tier].shrine_effect_bundles
          -- the custom effect bundle for Aten's shrine has a special key
          if god_key == deities.config.aten_god_key then shrine_effect_bundles = {{bundle = deities.config.aten_shrines_bundle}} end
     ...
     change_shrine_god = function(faction_key, region_key, old_god_key, new_god_key, source)
          ...
          if shrine and old_god_key then
               ...
               if slot_index then
                    ...
                    elseif source == deities.conversion_sources.local_deities_panel or source == deities.conversion_sources.rededication then
     ...
     get_shrines_under_conversion = function(faction_key, god_key)
          ...
          local result = is_table(deities.persistent[faction_key].shrines_under_conversion) and
                              table_find(deities.persistent[faction_key].shrines_under_conversion, function(e) return e.god_key == god_key end)
          if result then
               return result.data
          else
               return nil
     ...
     get_shrine_under_conversion_by_region = function(faction_key, region_key)
          ...
          if is_table(shrines_table) then
               for _, shrines_per_god in ipairs(shrines_table) do
                    ...
                    if shrine then return shrine, shrines_per_god.god_key end
               end
          else
               return nil
          end
     ...
     put_shrine_under_conversion = function(faction_key, god_key, region_key, favour)
          ...
          if index then
               ...
               deities.output(
                    "Could not find shrine to put under conversion for faction " .. tostring(faction_key) .. " for god " .. tostring(god_key) .. " for region " ..
                         region_key, 10)
          end
     end,
     ...
     update_shrine_favour = function(faction_key, god_key)
          ...
          if is_table(inactive_shrine_regions_table) then
               for i = #inactive_shrine_regions_table, 1, -1 do
                    deities.output("Faction " .. tostring(faction_key) .. " now gains favour for god " .. tostring(god_key) .. " from pre-existing shrine in " ..
                                        inactive_shrine_regions_table[i])
          ...
          local shrines_under_conversion = deities.get_shrines_under_conversion(faction_key, god_key)
          if is_table(shrines_under_conversion) then
               for _, shrine in ipairs(shrines_under_conversion) do god_slot.favour.shrine_favour = god_slot.favour.shrine_favour + shrine.favour end
          end
     ...
     faction_has_dwelling_gods = function(faction_key)
          ...
          for i = 1, deities.get_faction_god_slots_count(faction_key) do
               ...
               if god_key and deities.has_dwellings(god_key) then return true end
          end
          return false
     end,
     ...
     add_dwelling = function(faction_key, god_key, region_key)
          ...
          if deities.get_inactive_dwelling_in_region(faction_key, region_key) then
               ...
               if bonus_value_foreign_dwelling_converted_gold > 0 then
                    local resource_cost_object = cm:create_new_custom_resource_cost()
                    resource_cost_object:add_resource_cost("troy_gold", deities.config.resource_factor_gold_from_foreign_convesion,
                                                           bonus_value_foreign_dwelling_converted_gold)
                    local faction = cm:get_faction(faction_key)
                    cm:faction_apply_resource_transaction(faction, resource_cost_object)
               end
          end
     ...
     remove_dwelling = function(faction_key, god_key, region_key)
          ...
          if current_tier ~= -1 then
               ...
               -- Try to remove effects from all tiers since we do not keep favour and tiers of such gods
               for i = 1, #deities.config.favour_tiers do deities.remove_dwelling_effects_for_tier(faction_key, god_key, region_key, i) end
          end
     ...
     get_dwellings_under_conversion = function(faction_key, god_key)
          ...
          local result = is_table(deities.persistent[faction_key].dwellings_under_conversion) and
                              table_find(deities.persistent[faction_key].dwellings_under_conversion, function(e) return e.god_key == god_key end)
          if result then
               return result.data
          else
               return nil
     ...
     get_dwelling_under_conversion_by_region = function(faction_key, region_key)
          ...
          if is_table(dwellings_table) then
               for _, dwellings_per_god in ipairs(dwellings_table) do
                    ...
                    if dwelling then return dwelling, dwellings_per_god.god_key end
               end
          else
               return nil
          end
     ...
     put_dwelling_under_conversion = function(faction_key, god_key, region_key, favour)
          ...
          if index then
               ...
               deities.output("Could not find dwelling to put under conversion for faction " .. tostring(faction_key) .. " for god " .. tostring(god_key) ..
                                   " for region " .. region_key, 10)
          end
     end,
     ...
     update_dwelling_favour = function(faction_key, god_key)
          ...
          if is_table(inactive_dwelling_regions_table) then
               for i = #inactive_dwelling_regions_table, 1, -1 do
                    deities.output("Faction " .. tostring(faction_key) .. " now gains favour for god " .. tostring(god_key) .. " from pre-existing dwelling in " ..
                                        inactive_dwelling_regions_table[i])
          ...
          local dwellings_under_conversion = deities.get_dwellings_under_conversion(faction_key, god_key)
          if is_table(dwellings_under_conversion) then
               for _, dwelling in ipairs(dwellings_under_conversion) do god_slot.favour.dwelling_favour = god_slot.favour.dwelling_favour + dwelling.favour end
          end
     ...
     add_or_upgrade_temple = function(faction_key, god_key, region_key, level)
          ...
          if temple then
               ...
               if bonus_value_foreign_temple_converted_gold > 0 then
                    local resource_cost_object = cm:create_new_custom_resource_cost()
                    resource_cost_object:add_resource_cost("troy_gold", deities.config.resource_factor_gold_from_foreign_convesion,
                                                           bonus_value_foreign_temple_converted_gold)
          ...
          if temple then
               ...
               local event_data = {faction_key = faction_key, god_key = god_key, count = #god_slot.temples}
     ...
     get_temple_level = function(faction_key, region_key)
          if not is_table(deities.persistent[faction_key]) then return -1 end

          local god_slots = deities.get_god_slots(faction_key)
          for i = 1, deities.get_faction_god_slots_count(faction_key) do
               if god_slots[i].god_key then
                    local temple = table_find(god_slots[i].temples, function(e) return e.region_key == region_key end)
                    if temple then return temple.level end
               end
          end
     ...
     get_temples_under_conversion = function(faction_key, god_key)
          ...
          local result = is_table(deities.persistent[faction_key].temples_under_conversion) and
                              table_find(deities.persistent[faction_key].temples_under_conversion, function(e) return e.god_key == god_key end)
          if result then
               return result.data
          else
               return nil
     ...
     get_temple_under_conversion_by_region = function(faction_key, region_key)
          ...
          if is_table(temples_table) then
               for _, temples_per_god in ipairs(temples_table) do
                    ...
                    if temple then return temple, temples_per_god.god_key end
               end
          else
               return nil
          end
     ...
     put_temple_under_conversion = function(faction_key, god_key, region_key, favour, level)
          ...
          if index then
               ...
               deities.output(
                    "Could not find temple to put under conversion for faction " .. tostring(faction_key) .. " for god " .. tostring(god_key) .. " for region " ..
                         region_key, 10)
          end
     end,
     ...
     cancel_temple_conversion = function(faction_key, god_key, region_key)
          ...
          if not temple_under_conversion then
               deities.output("Could not find temple under conversion for faction " .. tostring(faction_key) .. " for god " .. tostring(god_key) .. " for region " ..
                                   region_key, 10)
               return
          end
     ...
     update_temple_favour = function(faction_key, god_key)
          ...
          if is_table(inactive_temples_table) then
               for i = #inactive_temples_table, 1, -1 do
                    deities.output("Faction " .. tostring(faction_key) .. " now gains favour for god " .. tostring(god_key) .. " from pre-existing temple in " ..
                                        inactive_temples_table[i].region_key)
          ...
          local temples_under_conversion = deities.get_temples_under_conversion(faction_key, god_key)
          if is_table(temples_under_conversion) then
               for _, temple in ipairs(temples_under_conversion) do god_slot.favour.temple_favour = god_slot.favour.temple_favour + temple.favour end
          end
     ...
     get_inactive_temple_in_region = function(faction_key, region_key)
          ...
          return table_find(deities.persistent[faction_key].inactive_temples, function(inactive_temple)
               return table_find(inactive_temple.data, function(inactive_temple_data) return inactive_temple_data.region_key == region_key end)
          end)
     end,
     ...
     find_region_slot_index_by_building_key = function(region_key, building_key)
          ...
          for i = 0, region_slots:num_items() - 1 do
               ...
               if building and not building:is_null_interface() and building:name() == building_key then return i end
          end
     ...
     find_force_slot_index_by_building_key = function(force_cqi, building_key)
          ...
          if not force_buildings then return nil end
          ...
          for i = 0, last_building_index do
               ...
               if force_building:name() == building_key then return i end
          end
     ...
     find_building_by_building_chain = function(region_key, building_chain, level, return_slot_index)
          ...
          for i = 0, region_slots:num_items() - 1 do
               ...
               if building and not building:is_null_interface() and building:name() == building_key then
                    if return_slot_index then return i end
                    return building
               end
          end
     ...
     get_building_slots_with_ongoing_contruction = function(faction_key)
          ...
          if not faction then return slots_table end
          ...
          for i = 0, region_list:num_items() - 1 do
               ...
               for slot_index = 0, slot_list:num_items() - 1 do
                    ...
                    if slot:is_there_construction() then table.insert(slots_table, {slot = slot, index = slot_index}) end
               end
          end
          return slots_table
     end,
     ...
     set_religious_buildings_chain_restriction = function(faction_key, god_key, should_restrict)
          local faction = cm:get_faction(faction_key)
          if not faction or faction:is_null_interface() or not faction:is_pharaoh_game_faction() then return end

          local restrictable_building_chains = {}

          local temple_chain = deities.get_god_temple_chain(god_key)
          if is_string(temple_chain) and temple_chain ~= "" then table.insert(restrictable_building_chains, temple_chain) end

          local shrine_chain = deities.get_god_shrine_chain(god_key)
          if is_string(shrine_chain) and shrine_chain ~= "" then table.insert(restrictable_building_chains, shrine_chain) end

          local dwelling_chain = deities.get_god_dwelling_chain(god_key)
          if is_string(dwelling_chain) and dwelling_chain ~= "" then table.insert(restrictable_building_chains, dwelling_chain) end

          local idol_chain = deities.get_god_idol_chain(god_key)
          if is_string(idol_chain) and idol_chain ~= "" then table.insert(restrictable_building_chains, idol_chain) end
     ...
     set_all_religious_buildings_chain_restrictions = function(factions_list)
          ...
          for _, god_data in ipairs(deities.gods) do
               ...
               if god_data.dwelling_chain then table.insert(deities.all_religious_buildings_chains, god_data.dwelling_chain) end
               if god_data.idol_chain then table.insert(deities.all_religious_buildings_chains, god_data.idol_chain) end
          end
                    ...
                    if deities.persistent[curr_faction_name] then
                         ...
                         for i = 1, god_slots_count do
                              ...
                              if god_key then
                                   ...
                                   if temple_chain then table.insert(worshipped_gods_buildings, temple_chain) end

                                   local shrine_chain = deities.get_god(god_key).shrine_chain
                                   if shrine_chain then table.insert(worshipped_gods_buildings, shrine_chain) end

                                   local dwelling_chain = deities.get_god(god_key).dwelling_chain
                                   if dwelling_chain then table.insert(worshipped_gods_buildings, dwelling_chain) end
     ...
     add_or_upgrade_idol = function(faction_key, god_key, force_cqi, level)
          ...
          if not god_slot then
               ...
               local idol_data = {force_cqi = force_cqi, level = level}
          ...
          if not new_idol_effect_bundles then return end
     ...
     remove_idol = function(faction_key, god_key, force_cqi)
          ...
          if current_tier ~= -1 then
               ...
               -- Try to remove effects from all tiers since we do not keep favour and tiers of such gods
               for i = 1, #deities.config.favour_tiers do deities.remove_idol_effects_for_tier(faction_key, god_key, force_cqi, i) end
          end
     ...
     remove_idol_effects_for_tier = function(faction_key, god_key, force_cqi, tier)
          ...
          if god_key == deities.config.aten_god_key then idol_effect_bundles = {{bundle = deities.config.aten_idols_bundle}} end

          if not idol_effect_bundles then return end
     ...
     get_idol_level = function(faction_key, force_cqi)
          ...
          for i = 1, deities.get_faction_god_slots_count(faction_key) do
               if god_slots[i].god_key then
                    ...
                    if idol then return idol.level end
               end
          end
     ...
     change_idol_god = function(faction_key, force_cqi, old_god_key, new_god_key, source)
          ...
          if not is_string(new_building_chain) or new_building_chain == "" then
               deities.output("Could not change idol for faction " .. faction_key .. ", force with cqi " .. tostring(force_cqi) .. " from god " .. old_god_key ..
                                   " to god " .. new_god_key, 10)
               return
          end

          if idol and old_god_key then
               deities.output(
                    "Changing idol for faction " .. faction_key .. " for force with cqi: " .. tostring(force_cqi) .. " from god " .. old_god_key .. " to god " ..
                         new_god_key)
     ...
     get_idols_under_conversion = function(faction_key, god_key)
          ...
          local result = is_table(deities.persistent[faction_key].idols_under_conversion) and
                              table_find(deities.persistent[faction_key].idols_under_conversion, function(e) return e.god_key == god_key end)
     ...
     get_idol_under_conversion_by_force = function(faction_key, force_cqi)
          ...
          if is_table(idols_table) then
               for _, idols_per_god in ipairs(idols_table) do
                    ...
                    if idol then return idol, idols_per_god.god_key end
               end
          else
               return nil
          end
     ...
     put_idol_under_conversion = function(faction_key, god_key, force_cqi, favour, level)
          ...
          if index then
               ...
               deities.output("Could not find idol to put under conversion for faction " .. faction_key .. " for god " .. god_key .. " for force with cqi " .. force_cqi,
                              10)
          end
     end,
     ...
     update_idol_favour = function(faction_key, god_key)
          ...
          if is_table(inactive_idols_table) then
               for i = #inactive_idols_table, 1, -1 do
                    deities.output("Faction " .. faction_key .. " now gains favour for god " .. god_key .. " from pre-existing idol in force with cqi: " ..
                                        tostring(inactive_idols_table[i].force_cqi))
          ...
          if not god_slot.idols then god_slot.idols = {} end
          ...
          local idols_under_conversion = deities.get_idols_under_conversion(faction_key, god_key)
          if is_table(idols_under_conversion) then
               for _, idol in ipairs(idols_under_conversion) do god_slot.favour.idol_favour = god_slot.favour.idol_favour + idol.favour end
          end
     ...
     get_inactive_idols = function(faction_key, god_key)
          ...
          if (not is_table(faction_table)) or (not is_table(faction_table.inactive_idols)) then
     ...
     add_cult_centre = function(faction_key, god_key)
          ...
          if not god_slot then
               ...
               if not is_table(deities.persistent[faction_key].inactive_cult_centres) then deities.persistent[faction_key].inactive_cult_centres = {} end
     ...
     update_cult_centre_favour = function(faction_key, god_key)
          ...
          if not deities.persistent[faction_key].inactive_cult_centres then deities.persistent[faction_key].inactive_cult_centres = {} end
          ...
          deities.output("Cult centre favour for faction " .. tostring(faction_key) .. " for god " .. tostring(god_key) .. " is now " ..
                              god_slot.favour.cult_centre_favour)
          deities.update_total_favour(faction_key, god_key)
     ...
     get_cult_centre_regions = function()
          local region_keys = {}
          for _, god_data in ipairs(deities.gods) do if #god_data.cult_centre_region_key > 0 then table.insert(region_keys, god_data.cult_centre_region_key) end end
          return region_keys
     end,
     ...
     get_tier_from_favour_amount = function(amount)
          for i = #deities.config.favour_tiers, 1, -1 do if amount >= deities.config.favour_tiers[i] then return i end end
          return -1
     end,
     ...
     grant_favour = function(faction_key, god_key, amount, source)
          ...
          if not god_slot.favour[source] then god_slot.favour[source] = 0 end
          god_slot.favour[source] = god_slot.favour[source] + amount
          if god_slot.favour[source] < 0 then god_slot.favour[source] = 0 end
     ...
     get_combined_custom_effect_bundle = function(bundles, init_bundle)
          if not is_table(bundles) then return nil end
     ...
     apply_effects_for_tier_change = function(faction_key, god_key, old_tier, new_tier, apply_negative_effects)
          ...
          if deities.has_faction_created_aten(faction_key) then deities.update_unique_effects(faction_key, old_tier, new_tier) end
     ...
     update_shrine_effects = function(faction_key, god_key, old_tier, new_tier)
          local god_slot = deities.get_god_slot(faction_key, god_key)
          if not god_slot then return end
          ...
          if #god_slot.shrine_regions > 0 then
               ...
               if old_tier >= deities.config.unlock_tiers.shrines then old_shrine_effect_bundles = tiers[old_tier].shrine_effect_bundles end
               if new_tier > 0 then new_shrine_effect_bundles = tiers[new_tier].shrine_effect_bundles end
     ...
     update_dwelling_effects = function(faction_key, god_key, old_tier, new_tier)
          ...
          if #god_slot.dwelling_regions > 0 then
               ...
               if old_tier >= deities.config.unlock_tiers.dwellings then old_dwelling_effect_bundles = tiers[old_tier].dwelling_effect_bundles end
               if new_tier > 0 then new_dwelling_effect_bundles = tiers[new_tier].dwelling_effect_bundles end
     ...
     update_idol_effects = function(faction_key, god_key, old_tier, new_tier)
          ...
          if not is_table(god_slot.idols) or table_size(god_slot.idols) < 1 then return end
          ...
          if old_tier >= deities.config.unlock_tiers.idols then old_idol_effect_bundles = tiers[old_tier].idol_effect_bundles end
          if new_tier > 0 then new_idol_effect_bundles = tiers[new_tier].idol_effect_bundles end
          local init_bundle = (god_key == deities.config.aten_god_key) and deities.config.aten_idols_bundle or nil
          ...
          for _, idol in ipairs(god_slot.idols) do
               ...
               if force and not force:is_null_interface() and force:has_general() then
                    if old_combined_custom_effect_bundle then cm:remove_effect_bundle_from_force(old_combined_custom_effect_bundle:key(), force_cqi) end
                    if new_combined_custom_effect_bundle then cm:apply_custom_effect_bundle_to_force(new_combined_custom_effect_bundle, force) end
               else
     ...
     update_armies_prayer_effects = function(faction_key, god_key, old_tier, new_tier)
          ...
          if #god_slot.armies_with_prayer_effects > 0 then
               ...
               if old_tier >= deities.config.unlock_tiers.prayers then old_prayer_effect_bundles = tiers[old_tier].prayer_effect_bundles end
               if new_tier > 0 then new_prayer_effect_bundles = tiers[new_tier].prayer_effect_bundles end
     ...
     update_devoted_armies_effects = function(faction_key, god_key, old_tier, new_tier, apply_negative_effects)
          ...
          for index, family_member_cqi in ipairs(god_slot.devoted_generals_family_member_cqi) do
               if family_member_cqi then
                    ...
                    if new_tier > 0 then new_devoted_effect_bundles = tiers[new_tier].devoted_effect_bundles end
     ...
     update_unique_effects = function(faction_key, old_tier, new_tier)
          ...
          local aten_slot = deities.get_aten_slot(faction_key)
          if not aten_slot then return end
          ...
          if region:owning_faction():name() == faction_key then
               ...
               if old_tier >= deities.config.aten_first_tier_with_unlockables then old_unique_effect_bundles = tiers[old_tier].unique_effect_bundles end
               if new_tier > 0 then new_unique_effect_bundles = tiers[new_tier].unique_effect_bundles end
     ...
     remove_aten_cult_centre_effects = function(previous_owner_faction_key)
          ...
          if current_tier <= 0 then return end
     ...
     update_total_favour = function(faction_key, god_key)
          ...
          for factor, value in pairs(god_slot.favour) do if factor ~= "total_favour" then god_slot.favour.total_favour = god_slot.favour.total_favour + value end end
          ...
          if old_total_favour ~= god_slot.favour.total_favour then
               core:trigger_event("LocalDeitiesGodTotalFavourChanged",
                                  {faction_key = faction_key, god_key = god_key, total_favour = god_slot.favour.total_favour, old_tier = old_tier, new_tier = new_tier})
          end
               ...
               if curr_faction:is_pharaoh_game_faction() then
                    if deities.persistent[curr_faction_name] then
                         ...
                         for j = 1, god_slots_count do
                              ...
                              -- if god is worshipped
                              if god_key then deities.update_all_favour_factors(curr_faction_name, god_key) end
                         end
                    else
                         deities.output("Error:" .. curr_faction_name .. " does not have a persistent table with god slots!")
                    end
          ...
          for i = 0, factions_list:num_items() - 1 do
               ...
               if curr_faction:is_pharaoh_game_faction() then
                    ...
                    if not curr_faction:is_human() then
                         ...
                         if gods then
                              for j = 1, #gods do
                                   if j > deities.config.init_god_slots then deities.unlock_god_slot(curr_faction_name) end
                         ...
                         if god_key then
                              ...
                              if curr_faction_name ~= local_faction_key or not deities.is_god_restricted_by_modular_difficulty(god_data.key, god_data.culture) then
     ...
     transfer_building = function(building, region_name, previous_faction, new_faction, slot_num)
          ...
          if god_table then
               ...
               if slot_num and cm:get_faction(new_faction):is_human() and deities.is_god_restricted_by_modular_difficulty(god_table.key, god_table.culture) then
     ...
     discover_all_gods = function()
          ...
          for _, god in ipairs(deities.gods) do deities.discover_god(faction_key, god.key) end
     end,
     ...
     discover_god = function(faction_key, god_key, god_culture_key, is_initial_god)
          -- this can occur for factions like "rebels"
          if not is_table(deities.persistent[faction_key]) then return false end
          ...
          if local_faction_key == faction_key and deities.is_god_restricted_by_modular_difficulty(god_key, god_culture_key) then
          ...
          if god_key ~= deities.config.aten_god_key then
               ...
               local event_data = {faction_key = faction_key, is_initial_god = is_initial_god, god_loc_key = god_name_loc_key}
     ...
     prevent_god_discovery = function(faction_key, god_key)
          if not cm:get_local_faction(true) then return end
          local local_faction_key = cm:get_local_faction(true):name()
     ...
     autodiscover_gods_of_culture = function(culture_key)
          ...
          for _, god_data in ipairs(deities.gods) do
               if god_data.culture == culture_key then deities.discover_god(local_faction_key, god_data.key, culture_key) end
          end
     end,
     ...
     worship_god = function(faction_key, slot_num, god_key)
          ...
          for i = 1, deities.get_faction_god_slots_count(faction_key) do
               if deities.persistent[faction_key].god_slots[i].god_key == god_key then
                    deities.output(
                         "Faction " .. tostring(faction_key) .. " attempted to worship god " .. tostring(god_key) .. ", but it is already worshiped on slot " .. i, 10)
                    return
               end
          end
          ...
          local event_data = {faction_key = faction_key, new_god_key = god_key, old_god_key = nil}
          ...
          if god_slot.god_key then
               ...
               if deities.has_dwellings(old_god_key) and not deities.has_dwellings(god_key) then deities.demolish_dwellings(faction_key, old_god_key) end
               ...
               deities.output("Faction " .. tostring(faction_key) .. " now worships god " .. tostring(god_key) .. " in slot " .. slot_num .. " instead of god " ..
                                   god_slot.god_key)
               ...
               if handle_cult_centre then deities.add_cult_centre(faction_key, old_god_key) end
               ...
               if faction_key == cm:get_local_faction_name(true) then deities.update_local_deities_notification() end
          end
     ...
     ai_attempt_to_worship_new_god = function(faction_key)
          ...
          if deities.persistent[faction_key].god_slots[1].god_key == nil and deities.ai_gods[faction_key] then return end
          ...
          if empty_slot_index == -1 then return end

          local legitimacy_path_obj = legitimacy_choice:get_unlocked_legitimacy(faction_key)
          if not legitimacy_path_obj then return end
          ...
          if deities.has_faction_discovered_god(faction_key, favoured_deity) and not deities.get_god_slot(faction_key, favoured_deity) then
               ...
               if worship_slot_index > unlocked_slots_count then deities.unlock_god_slot(faction_key) end
     ...
     get_hecatomb_cooldown_remaining = function(faction_key)
          if not deities.persistent[faction_key].last_hecatomb_turn then return 0 end
     ...
     get_hecatomb_cooldown_bonus = function(faction_key) return cm:get_faction(faction_key):bonus_values():basic_value("hecatomb_cooldown_add") end,

     get_hecatomb_cost = function(faction_key, god_key)
          local hecatomb_cost = cm:create_new_custom_resource_cost()

          local god_slot = deities.get_god_slot(faction_key, god_key)
          if not god_slot then return hecatomb_cost end
     ...
     make_prayer = function(faction_key, god_key, force_cqi)
          ...
          if current_tier >= deities.config.unlock_tiers.prayers then
               ...
               if combined_custom_effect_bundle and prayer_effect_duration > 0 then
                    ...
                    local bonus_happiness_from_prayer = cm:get_forces_bonus_value(force, deities.config.happiness_from_prayer_bonus_value)
                    if bonus_happiness_from_prayer ~= 0 then
                         combined_custom_effect_bundle:add_effect(deities.config.happiness_from_prayer_character_effect,
                                                                  deities.config.happiness_from_prayer_character_effect_scope, bonus_happiness_from_prayer)
                    end
                    ...
                    if found_index then
                         god_slot.armies_with_prayer_effects[found_index].turns_left = math.max(prayer_effect_duration,
                                                                                                god_slot.armies_with_prayer_effects[found_index].turns_left)
                    else
                    ...
                    local event_data = {force = force, faction = faction, god_key = god_key}
               ...
               deities.output("Faction " .. tostring(faction_key) .. " is trying to make a prayer to god " .. tostring(god_key) .. " on tier " .. current_tier ..
                                   " but it needs tier " .. deities.config.unlock_tiers.prayers, 10)
          end
     end,
     ...
     assign_devoted_general = function(faction_key, god_key, index, family_member_cqi)
          ...
          if tier >= deities.config.unlock_tiers.devoted_generals then
               ...
               if general and not general:is_null_interface() then
                    ...
                    local god_data = deities.get_god(god_key)
                    if god_data then cm:set_script_state(general, "devoted_god_image", god_data.god_slot_image) end
               end
               deities.output("Faction " .. tostring(faction_key) .. " assigned devoted general with family member CQI " .. family_member_cqi .. " to god " ..
                                   tostring(god_key))
          else
               deities.output("Faction " .. tostring(faction_key) .. " is trying to assign devoted general to god " .. tostring(god_key) .. " on tier " .. tier ..
                                   " but it needs tier " .. deities.config.unlock_tiers.devoted_generals, 10)
          end
          ...
          if new_devoted_effect_bundles then
               ...
               local new_combined_custom_effect_bundle = deities.get_combined_custom_effect_bundle(new_devoted_effect_bundles, init_bundle)
               local general = deities.get_devoted_general(faction_key, god_key, index)
               if general and not general:is_null_interface() then cm:apply_custom_effect_bundle_to_character(new_combined_custom_effect_bundle, general) end
          else
     ...
     remove_devoted_general = function(faction_key, god_key, index, apply_negative_effects, old_tier)
          ...
          if apply_negative_effects then
               cm:apply_effect_bundle_to_character(deities.config.devoted_general_negative_effect_bundle, general:command_queue_index(),
                                                   deities.config.devoted_general_negative_effect_bundle_duration)
          end

          local god = deities.get_god(god_key)
          local current_tier = deities.get_tier(faction_key, god_key)
          if old_tier and old_tier > current_tier then current_tier = old_tier end
          local tiers = deities.get_god_tiers(faction_key, god_key)
          if not is_table(tiers) then return end
          ...
          local god_name_loc_key = deities.get_localised_text(god_key).name_source
          deities.add_deities_event_message("local_deity_hero_devotion_suffers", faction_key, msg_index, god_name_loc_key,
                                            cm:char_lookup_str(general:command_queue_index()))
     ...
     get_devoted_general = function(faction_key, god_key, index)
          ...
          if not devoted_generals_family_member_cqi then return nil end

          local family_member = cm:get_family_member_by_cqi(devoted_generals_family_member_cqi)
          if family_member then return family_member:character() end
          return nil
     end,
     ...
     get_aten_devoted_general_slots_at_tier = function(faction_key, tier)
          ...
          if not deities.has_faction_created_aten then return result end
          ...
          if is_table(tiers[tier]) and is_table(tiers[tier].unique_effect_bundles) then
               for _, bundle in ipairs(tiers[tier].unique_effect_bundles) do
                    if bundle.bundle == deities.config.aten_extra_general.bundle then result = result + 1 end
               end
          end
          return result
     end,
     ...
     get_devoted_general_slots = function(faction_key)
          if not deities.has_faction_created_aten(faction_key) then return 1 end
     ...
     is_devoted_general_unlocked = function(faction_key, god_key, index)
          local god_slot = deities.get_god_slot(faction_key, god_key)
          if not god_slot then
               deities.output("Checking is devoted general unlocked for faction " .. tostring(faction_key) .. " for god " .. tostring(god_key) ..
                                   "but the god is not worshipped!", 10)
               return false
          end

          local tier = deities.get_tier(faction_key, god_key)
          if god_key ~= deities.config.aten_god_key then return tier >= deities.config.unlock_tiers.devoted_generals end
     ...
     is_devoted_general = function(faction_key, general_family_member_cqi)
          ...
          for i = 1, deities.get_faction_god_slots_count(faction_key) do
               ...
               if devoted_general_index then return true end
          end
          return false
     end,

     get_bundle_for_prayer = function(agent_action_key, character)
          if not agent_action_key or agent_action_key == "" or not character then return nil end

          local index
          for i, prefix in ipairs(deities.config.pray_interaction_prefixes) do if string.find(agent_action_key, prefix) then index = i end end
          ...
          if force:is_null_interface() then return nil end

          local god_slot = deities.get_god_slot(faction_key, god_key)
          if not god_slot then return nil end
               ...
               if god_slot and god_slot.god_key then
                    ...
                    for j = 1, general_slots do
                         if deities.is_devoted_general_unlocked(faction_name, god_key, j) then
                              ...
                              if not devoted_general_family_member_cqi then return true end
                         end
                    end
               end
          end
     ...
     claim_akhenaten = function(faction_key)
          ...
          if god_slots then
               ...
               for i = 1, deities.get_faction_god_slots_count(faction_key) do
                    ...
                    if god_key then
                         if deities.has_dwellings(god_key) then deities.demolish_dwellings(faction_key, god_key, true) end
     ...
     has_faction_created_aten = function(faction_key)
          local aten_slot = deities.get_aten_slot(faction_key)
          if not aten_slot then return false end
     ...
     demolish_temples_and_shrines = function(faction_key, god_key)
          ...
          if not god_data then return end
          ...
          for _, temple in ipairs(god_data.temples) do
               ...
               if slot_index then cm:instantly_dismantle_building_in_region(region_key, slot_index + 1, true) end
          end
          ...
          for _, shrine_region_key in ipairs(god_data.shrine_regions) do
               ...
               if slot_index then cm:instantly_dismantle_building_in_region(shrine_region_key, slot_index + 1, true) end
          end
     end,
     ...
     demolish_idols = function(faction_key, god_key, in_construction)
          ...
          for _, idol in ipairs(god_data.idols) do
               ...
               if slot_index then cm:instantly_dismantle_building_in_force(force_cqi, slot_index + 1, true) end
          end

          if not in_construction then return end
     ...
     demolish_dwellings = function(faction_key, god_key, in_construction)
          ...
          for _, dwelling_region_key in ipairs(god_data.dwelling_regions) do
               ...
               if slot_index then cm:instantly_dismantle_building_in_region(dwelling_region_key, slot_index + 1, true) end
          end
     ...
     get_idol_refund_cost = function(faction_key)
          ...
          local god_slots = deities.get_god_slots(faction_key)
          if not god_slots then return total_resource_cost end
                         ...
                         for i = 0, force_list:num_items() - 1 do
                              ...
                              if force_slots then
                                   ...
                                   for i = 0, last_slot_index do
                                        ...
                                        if slot:is_there_construction() then
                                             local chain = slot:construction_building_chain_key()
                                             local idol_chain_god = table_find(deities.gods, function(e)
                                                  return e.idol_chain == chain
                                             end)
                                             -- Check if the building god matches god_key
                                             if idol_chain_god and idol_chain_god.key == god_key then
          ...
          for i = 1, deities.get_faction_god_slots_count(faction_key) do
               ...
               if god_key and deities.has_dwellings(god_key) then
                    ...
                    for _, dwelling_region in ipairs(god_slot.dwelling_regions) do
                         ...
                         if building and not building:is_null_interface() then total_resource_cost:add(cm:get_building_refund_cost(building)) end
                    end
     ...
     convert_completed_religious_buildings = function(faction_key, old_god_slot, new_god_key, source)
          ...
          for _, temple in ipairs(temples_copy) do deities.change_temple_god(faction_key, temple.region_key, old_god_slot.god_key, new_god_key, source) end
          ...
          for _, idol in ipairs(idols_copy) do deities.change_idol_god(faction_key, idol.force_cqi, old_god_slot.god_key, new_god_key, source) end
     end,
     ...
     convert_religious_buildings_in_construction = function(faction_key, old_god_key, new_god_key)
          ...
          for _, slot_data in ipairs(slots_with_construction) do
               ...
               if (temple_chain_god or shrine_chain_god) and
                    (not old_god_key or (temple_chain_god and temple_chain_god.key == old_god_key) or (shrine_chain_god and shrine_chain_god.key == old_god_key)) then
                    local level = slot_data.slot:construction_building_level_record_level()
     ...
     create_aten_from_gods = function(faction_key, god_keys)
          ...
          if god_slots then
               for i = 1, deities.get_faction_god_slots_count(faction_key) do
                    if god_slots[i].god_key then
                         ...
                         core:trigger_event("LocalDeitiesGodTotalFavourChanged",
                                            {faction_key = faction_key, god_key = old_god_key, total_favour = 0, old_tier = tier, new_tier = 0})
                    end
               end
          end
          ...
          local local_faction_key = cm:get_local_faction_name(true)
          if faction_key == local_faction_key then deities.open_aten() end
     end,
     ...
     get_aten_pending_choices = function(faction_key)
          if not is_table(deities.persistent[faction_key]) then return 0 end

          local aten_slot = deities.get_aten_slot(faction_key)
          if not aten_slot or not aten_slot.pending_choices then return 0 end
                    ...
                    for _, tier in ipairs(tiers) do
                         if is_table(tier.shrine_effect_bundles) then
                              for _, bundle in ipairs(tier.shrine_effect_bundles) do
                                   ...
                                   aten_slot.weighted_unlockables:add_item({bundle = bundle, category = deities.unlockable_categories.shrines},
                                                                           bundle.aten_unlockable_random_weight)
                              end
                         end
                         ...
                         if is_table(tier.idol_effect_bundles) then
                              for _, bundle in ipairs(tier.idol_effect_bundles) do
                                   bundle.god_key = god.key
                                   aten_slot.weighted_unlockables:add_item({bundle = bundle, category = deities.unlockable_categories.idols},
                                                                           bundle.aten_unlockable_random_weight)
                              end
                         end
                         ...
                         if is_table(tier.prayer_effect_bundles) then
                              for _, bundle in ipairs(tier.prayer_effect_bundles) do
                                   bundle.god_key = god.key
                                   aten_slot.weighted_unlockables:add_item({bundle = bundle, category = deities.unlockable_categories.prayer},
                                                                           bundle.aten_unlockable_random_weight)
                              end
                         end
                         ...
                         if is_table(tier.devoted_effect_bundles) then
                              for _, bundle in ipairs(tier.devoted_effect_bundles) do
                                   bundle.god_key = god.key
                                   aten_slot.weighted_unlockables:add_item({bundle = bundle, category = deities.unlockable_categories.devoted_army},
                                                                           bundle.aten_unlockable_random_weight)
                              end
                         end
                    end
     ...
     remove_unlockables_from_category = function(list, category)
          for i = #list.items, 1, -1 do if list.items[i].item.category == category then list:remove_item(i) end end
     end,

     get_next_random_aten_unlockables = function(faction_key)
          local aten_slot = deities.get_aten_slot(faction_key)
          if not aten_slot then return end
          if is_table(aten_slot.pending_unlockables) then return aten_slot.pending_unlockables end
          return nil
     end,
     ...
     set_next_random_aten_unlockables = function(faction_key)
          local aten_slot = deities.get_aten_slot(faction_key)
          if not aten_slot then return end
          if not is_table(aten_slot.pending_unlockables) then aten_slot.pending_unlockables = {} end
          ...
          for i = #aten_slot.pending_unlockables, 1, -1 do aten_slot.pending_unlockables[i] = nil end
          ...
          for i = 1, deities.config.aten_unlockable_choices do
               ...
               if choice then
                    ...
                    if i < deities.config.aten_unlockable_choices then deities.remove_unlockables_from_category(unlockables_copy, choice.category) end
               end
          end
     end,
     ...
     select_aten_unlockable = function(faction_key, bundle_key, category)
          ...
          if category ~= deities.unlockable_categories.extra_general then
               ...
               -- The weighted list must be re-initialised after loading, or it will not find its methods
               aten_slot.weighted_unlockables = weighted_list:new(aten_slot.weighted_unlockables)
               if index_to_remove then aten_slot.weighted_unlockables:remove_item(index_to_remove) end
          end
          ...
          if aten_slot.max_tier_selected_unlockable < deities.config.aten_first_tier_with_unlockables then
               ...
               for i = 1, deities.config.aten_first_tier_with_unlockables - 1 do aten_slot.unlockables_per_tier[i] = {} end
          end

          aten_slot.unlockables_per_tier[aten_slot.max_tier_selected_unlockable] = {bundle = bundle_data, category = category}
          ...
          if aten_slot.max_tier_selected_unlockable < #tiers then deities.set_next_random_aten_unlockables(faction_key) end
          ...
          if aten_slot.max_unlocked_devoted_generals < general_slot_count then aten_slot.max_unlocked_devoted_generals = general_slot_count end
     ...
     get_effect_bundle_data = function(faction_key, bundle_key, category)
          if category == deities.unlockable_categories.extra_general then return deities.config.aten_extra_general end
                         ...
                         for _, current_tier in ipairs(tiers) do
                              if category == deities.unlockable_categories.shrines then
                                   if is_table(current_tier.shrine_effect_bundles) then
                                        local bundle = table_find(current_tier.shrine_effect_bundles, function(e)
                                             return e.bundle == bundle_key
                                        end)
                                        if bundle then return bundle end
                                   end
                              elseif category == deities.unlockable_categories.idols then
                                   if is_table(current_tier.idol_effect_bundles) then
                                        local bundle = table_find(current_tier.idol_effect_bundles, function(e)
                                             return e.bundle == bundle_key
                                        end)
                                        if bundle then return bundle end
                                   end
                              elseif category == deities.unlockable_categories.prayer then
                                   if is_table(current_tier.prayer_effect_bundles) then
                                        local bundle = table_find(current_tier.prayer_effect_bundles, function(e)
                                             return e.bundle == bundle_key
                                        end)
                                        if bundle then return bundle end
                                   end
                              elseif category == deities.unlockable_categories.devoted_army then
                                   if is_table(current_tier.devoted_effect_bundles) then
                                        local bundle = table_find(current_tier.devoted_effect_bundles, function(e)
                                             return e.bundle == bundle_key
                                        end)
                                        if bundle then return bundle end
                                   end
     ...
     has_faction_aten_unlockable_available = function(faction_name)
          ...
          if aten_pending_unlocks > 0 then return true end
          return false
     end,
     ...
     get_localised_text = function(god_key)
          local result = {name = "", name_source = "", flavour = "", flavour_source = ""}

          local god = deities.get_god(god_key)
          if not god then return result end
     ...
     get_localised_unlockable_text = function(bundle)
          local result = {flavour_localised = "", flavour_source = ""}
     ...
     display_all_gods = function()
          ...
          if worshipped_tab then worshipped_tab:SetState("active") end
          local all_gods_tab = deities.panel:SequentialFind(deities.component_ids.all_gods_tab)
          if all_gods_tab then all_gods_tab:SetState("selected") end
          ...
          if tabs_holder then
               ...
               if not deities.ui_data.active_tab then
                    ...
                    if faction_key then
                         ...
                         if not culture_index then culture_index = 1 end
                    end
               ...
               for i = 1, #deities.component_ids.tab_buttons do
                    ...
                    if tab_component then
                         ...
                         if new_god_component then new_god_component:SetVisible(false) end
     ...
     display_all_gods_list = function(gods_list)
          if not gods_list then return end
          ...
          for i = 1, #deities.component_ids.culture_tabs do
               ...
               if current_tab_content_component then
                    ...
                    -- Sea gods are only visible to sea factions that have not claimed Akhenaten
                    if (i == 1 and not deities.has_faction_claimed_akhenaten(faction_key)) or
                         (deities.component_ids.tab_buttons[i] == "sea_peoples_tab_button" and not deities.faction_has_access_to_idols(faction_key)) then
                         ...
                         if god_card_template then
                              ...
                              if holder_component then
                                   ...
                                   for j = 1, #gods do
                                        ...
                                        local new_god_component = UIComponent(holder_component:CreateFromComponent(god_card_template:Address(), string.format(
                                                                                                                        deities.component_ids.god_instance_prefix ..
                                                                                                                             tostring(god_key))))
                                        ...
                                        if god_portrait_component then
                                             ...
                                             local god = deities.get_god(god_key)
                                             if god and god.tab_image then god_portrait_component:SetImagePath(god.tab_image) end
                                        end
                                   end
                              end
                         end
          ...
          if all_gods_holder then all_gods_holder:InterfaceFunction("initialise", deities.ui_data.active_tab) end
     end,
     ...
     set_god_tooltip = function(god_key, component)
          ...
          if not tooltip_component then return end
          ...
          local god = deities.get_god(god_key)
          if god then cco_table.Type = common.get_localised_string("ui_text_replacements_localised_text_" .. god.epithet) end
          ...
          if god_key == deities.config.aten_god_key and unique_holder_component then unique_holder_component:SetVisible(true) end

          local has_dwellings = deities.has_dwellings(god_key)
          if dwellings_holder_component then dwellings_holder_component:SetVisible(has_dwellings) end
          ...
          if has_dwellings then deities.instantiate_tooltip_bonuses(devoted_holder_component, bonuses.devoted_bonuses) end
     ...
     toggle_culture_tabs_visibility = function(visible) common.set_context_value(deities.context_values.show_culture_tabs, visible and 1 or 0) end,

     toggle_worshipped_gods_tabs_visibility = function(visible) common.set_context_value(deities.context_values.show_worshipped_gods_tabs, visible and 1 or 0) end,

     toggle_gods_list_visibility = function(visible) common.set_context_value(deities.context_values.show_all_gods, visible and 1 or 0) end,

     toggle_gods_description = function(visible) common.set_context_value(deities.context_values.show_gods_description, visible and 1 or 0) end,

     -- use display_god_slots to show god slots, otherwise issues with favour tooltips occur
     hide_god_slots = function() common.set_context_value(deities.context_values.show_god_slots, 0) end,

     hide_all_gods = function()
          local all_gods_holder = deities.panel:SequentialFind(deities.component_ids.all_gods_hodler)
          if all_gods_holder then all_gods_holder:InterfaceFunction("save_starting_slider_value") end
     ...
     toggle_worship_button_active = function(active)
          ...
          if not selected_god_component then return end
     ...
     toggle_worship_button_visible = function(visible)
          ...
          local worship_button_component = selected_god_component:SequentialFind(deities.component_ids.worship_button)
          if worship_button_component then worship_button_component:SetVisible(visible) end
     end,
     ...
     toggle_aten_background = function(is_aten)
          ...
          if not background_component then return end
     ...
     toggle_selected_god = function(visible)
          local selected_god_component = deities.panel:SequentialFind(deities.component_ids.selected_god)
          if selected_god_component then selected_god_component:SetVisible(visible) end
     end,
     ...
     display_god_slots = function()
          ...
          local worshipped_tab = deities.panel:SequentialFind(deities.component_ids.worshipped_tab)
          if worshipped_tab then worshipped_tab:SetState("selected") end
          local all_gods_tab = deities.panel:SequentialFind(deities.component_ids.all_gods_tab)
          if all_gods_tab then all_gods_tab:SetState("active") end
          ...
          if not worshipped_gods_holder then return end
          ...
          if not worshipped_gods_inner_holder then return end

          worshipped_gods_inner_holder:DestroyChildren()

          local god_slot_template = deities.has_faction_created_aten(faction_key) and deities.ui_data.templates.aten_god_slot_template or
                                         deities.ui_data.templates.god_slot_template
          if not god_slot_template then return end

          for i = #deities.ui_data.god_slot_army_button_components, 1, -1 do table.remove(deities.ui_data.god_slot_army_button_components, i) end
          ...
          for i = 1, #god_slots do
               ...
               if favour_bar_component then deities.init_god_slot_favour_bar_component(favour_bar_component, god_slots[i]) end
               ...
               if army_holder_component and deities.ui_data.templates.army_button_template then
                    ...
                    -- end
                    for j = 1, general_slots do deities.init_army_button_component(army_holder_component, dev_button_pray, i, j) end
               end
          end
     end,
     ...
     init_god_slot_components = function(god_slot_component, god_slot, god, slot_index, is_from_faction_summary)
          ...
          if not god_portrait_holder_component then return end
          ...
          if not god_slot_portrait_button then return end
          ...
          if god_slot and slot_index <= deities.get_faction_god_slots_count(faction_key) then
               if god_slot.god_key then
                    ...
                    if available_btn then available_btn:SetVisible(false) end
                    ...
                    if favour_bar_component then deities.init_favour_tooltip(favour_bar_component, god_slot, is_from_faction_summary) end
                    ...
                    if shrines_button then shrines_button:SetVisible(true) end
               else
                    ...
                    local shrines_button = god_slot_component:SequentialFind(deities.component_ids.shrines_button)
                    if shrines_button then shrines_button:SetVisible(false) end
               end
          else
     ...
     init_god_slot_favour_bar_component = function(favour_bar_component, god_slot)
          if god_slot and god_slot.god_key then
               ...
               if favour_tier_component then favour_tier_component:SetText(tier) end
               if favour_amount_text_component then
                    ...
                    if tier < #tiers then tier = tier + 1 end
     ...
     init_army_button_component = function(army_holder_component, dev_button_pray, god_slot_index, devoted_general_index)
          local army_button_component = UIComponent(army_holder_component:CreateFromComponent(deities.ui_data.templates.army_button_template:Address(),
                                                                                              deities.component_ids.devoted_general_instance_prefix ..
                                                                                                   devoted_general_index))
               ...
               if god_slots[god_slot_index].god_key then
                    ...
                    if not deities.is_devoted_general_unlocked(faction_key, god_key, devoted_general_index) then
                         ...
                         if devoted_general_family_member_cqi then
                              ...
                              if army_portrait_component then army_portrait_component:SetVisible(true) end
                              ...
                              if dev_button_pray then
                                   if general then
                                        ...
                                        local lua_cmd =
                                             "dev_ui#deities.make_prayer(\"" .. tostring(faction_key) .. "\", \"" .. tostring(god_key) .. "\", " .. force_cqi .. ")"
                                        dev_button_pray:SetProperty("lua_cmd", lua_cmd)
                                   end
     ...
     init_favour_tooltip = function(component, god_slot, is_from_faction_summary)
          ...
          if god and god.god_slot_image then cco_table.IconPath = god.god_slot_image end
          ...
          cco_table.TotalList = {{Name = favour_text, Value = god_slot.favour.total_favour}}
     ...
     init_god_card_templates = function()
          if deities.ui_data.templates.god_card_templates then return end
          ...
          if gods_list_component then
               for i = 1, #deities.component_ids.culture_tabs do
                    ...
                    if current_tab_content then
                         local god_template = current_tab_content:SequentialFind(deities.component_ids.god_culture_tab_holder, deities.component_ids.god_template)
     ...
     init_god_slot_ui_template = function()
          if deities.ui_data.templates.god_slot_template and deities.ui_data.templates.army_button_template and deities.ui_data.templates.aten_god_slot_template then
               return
          end
          ...
          if not army_button_component then return end

          local aten_god_slot_template = deities.panel:SequentialFind(deities.component_ids.worshipped_gods_holder, deities.component_ids.aten_god_slot_template)

          if not aten_god_slot_template then return end

          local aten_army_button = aten_god_slot_template:SequentialFind(deities.component_ids.god_slot_army_button)
          if aten_army_button then aten_army_button:DivorceFromParent() end
     ...
     init_lock_ui_template = function()
          ...
          if not hecatomb_tier_template then return end
     ...
     init_aten_bonus_template = function()
          if deities.ui_data.templates.aten_bonus_template then return end

          local aten_bonus_template = deities.panel:SequentialFind(deities.component_ids.aten_panel, deities.component_ids.aten_bonus_template)

          if not aten_bonus_template then return end
     ...
     init_army_template = function()
          if deities.ui_data.templates.army_template and deities.ui_data.templates.no_generals_template then return end

          local army_template = deities.panel:SequentialFind(deities.component_ids.army_template)
          if not army_template then return end
          ...
          if not no_generals_template then return end
     ...
     init_shrine_location_and_toggle_template = function()
          if deities.ui_data.templates.shrines_toggle_template and deities.ui_data.templates.shrines_location_template and deities.ui_data.no_shrines_template and
               deities.ui_data.no_temples_template and deities.ui_data.no_dwellings_template and deities.ui_data.no_idols_template then return end

          local location_template = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.shrines_content,
                                                                 deities.component_ids.shrines_parent, deities.component_ids.shrines_expanding_list_items,
                                                                 deities.component_ids.shrines_location_template)

          if not location_template then return end

          local shrines_toggle_template = location_template:SequentialFind(deities.component_ids.shrines_toggles, deities.component_ids.shrines_toggle_holder,
                                                                           deities.component_ids.shrines_toggle_template)

          if not shrines_toggle_template then return end

          local no_shrines_template = deities.panel:SequentialFind(deities.component_ids.no_shrines_text)
          if not no_shrines_template then return end

          local no_temples_template = deities.panel:SequentialFind(deities.component_ids.no_temples_text)
          if not no_temples_template then return end

          local no_dwellings_template = deities.panel:SequentialFind(deities.component_ids.no_dwellings_text)
          if not no_dwellings_template then return end

          local no_idols_template = deities.panel:SequentialFind(deities.component_ids.no_idols_text)
          if not no_idols_template then return end
     ...
     init_aten_creation_god_templates = function()
          if deities.ui_data.templates.aten_creation_god_template and deities.ui_data.templates.aten_god_creation_god_holder then return end

          local aten_creation_component = deities.panel:SequentialFind(deities.component_ids.aten_creation)
          if not aten_creation_component then return end

          local pool_and_effects_holder = aten_creation_component:SequentialFind(deities.component_ids.aten_pool_and_effects_holder)
          if not pool_and_effects_holder then return end
     ...
     init_aten_creation_god_bonus_effect_templates = function()
          if deities.ui_data.templates.aten_shrines_effects_holder_template and deities.ui_data.templates.aten_prayers_effects_holder_template and
               deities.ui_data.templates.aten_devoted_armies_effects_holder_template then return end

          local aten_bonus_effects_holder = deities.panel:SequentialFind(deities.component_ids.aten_bonus_effects_holder)
          if not aten_bonus_effects_holder then return end
          ...
          if not aten_bonus_effects_holder_list_box then return end
     ...
     init_aten_unlockable_template = function()
          if deities.ui_data.templates.aten_unlockable then return end

          local unlockable_template = deities.panel:SequentialFind(deities.component_ids.aten_unlockable_template)
          if not unlockable_template then return end
     ...
     init_resource_template = function()
          if deities.ui_data.templates.resource_template then return end

          local resource_template = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.resources_template)

          if not resource_template then return end
     ...
     init_realm_name_template = function()
          if deities.ui_data.templates.realm_name_template then return end

          local realm_name_template = deities.panel:SequentialFind(deities.component_ids.realms_list_holder, deities.component_ids.realm_name_template)

          if not realm_name_template then return end
     ...
     init_rededication_result_template = function()
          if deities.ui_data.templates.rededication_result then return end

          local result_template = deities.panel:SequentialFind(deities.component_ids.rededicate_dialogue, deities.component_ids.worship_result_template)

          if not result_template then return end
     ...
     hide_not_selected_god_component = function()
          ...
          if not_selected_component then not_selected_component:SetVisible(false) end
     end,

     display_discovered_god_animation = function(gods)
          if not is_table(gods) or #gods == 0 then return end
          ...
          for _, god_key in ipairs(gods) do
               local new_god_component = UIComponent(gods_holder:CreateFromComponent(god_template:Address(),
                                                                                     string.format(deities.component_ids.god_instance_prefix .. god_key)))
     ...
     hide_discovered_god_animation = function()
          local discovered_god_animation = core:get_or_create_component("discovered_god_animation", deities.component_ids.discovered_layout_path)
          if discovered_god_animation then discovered_god_animation:SetVisible(false) end
     end,
     ...
     open_selected_god = function(god_key)
          ...
          if deities.get_god_slot(faction_key, god_key) or deities.has_faction_created_aten(faction_key) then
               ...
               if undiscovered_warning then undiscovered_warning:SetVisible(false) end
          else
          ...
          if god_name_component then god_name_component:SetText(localised_text.name, localised_text.name_source) end
          ...
          if deities.is_sea_god(god_key) then
               manage_buildings_button = selected_god_component:SequentialFind(deities.component_ids.idols_holder, deities.component_ids.shrines_button)
          else
               manage_buildings_button = selected_god_component:SequentialFind(deities.component_ids.shrines_holder, deities.component_ids.shrines_button)
          end

          if manage_buildings_button then manage_buildings_button:SetVisible(is_worshipped) end
          ...
          if god_illustration_component then if god and god.main_image then god_illustration_component:SetImagePath(god.main_image) end end
     ...
     display_cult_centre = function()
          ...
          if not cult_centre_holder_component then return end
          ...
          local god = deities.get_god(god_key)
          if cult_centre_holder_component then cult_centre_holder_component:SetVisible(god.cult_centre_chain and god.cult_centre_chain ~= "") end

          if is_discovered then
               local region_key = deities.get_god(deities.ui_data.selected_god).cult_centre_region_key
               if region_key then
                    if cult_centre_text_component then cult_centre_text_component:SetState("default") end
                    if cult_centre_zoom_button then cult_centre_zoom_button:SetVisible(true) end
                    local region = cm:get_region(region_key)
               ...
               if cult_centre_zoom_button then cult_centre_zoom_button:SetVisible(false) end
          end
     end,
     ...
     display_realm_names = function()
          ...
          if not has_realms then return end

          realm_names_list_component:DestroyChildren()
          for i = 1, #god.realms do
               local realm_key = god.realms[i]
               local realm_name_component =
                    UIComponent(realm_names_list_component:CreateFromComponent(deities.ui_data.templates.realm_name_template:Address(), realm_key))
     ...
     zoom_to_realm = function(realm_key)
          ...
          for _, region_key in ipairs(regions) do
               ...
               if region and not region:is_null_interface() then
                    ...
                    if min_region_x == nil or min_region_x > settlement_x then min_region_x = settlement_x end

                    if min_region_y == nil or min_region_y > settlement_y then min_region_y = settlement_y end

                    if max_region_x == nil or max_region_x < settlement_x then max_region_x = settlement_x end

                    if max_region_y == nil or max_region_y < settlement_y then max_region_y = settlement_y end
               end
          end
     ...
     display_favour_bar = function()
          ...
          if not bar_holder_component then return end
          ...
          if not bar_base_component then return end
          ...
          local god_slot = deities.get_god_slot(faction_key, god_key)
          if bar_fill_component then deities.set_favour_bar_fill(total_width, height, bar_fill_component, god_slot, tiers) end
          ...
          for _, component_name in ipairs(deities.component_ids.hecatomb_decorations) do
               ...
               if hecatomb_decoration then hecatomb_decoration:SetVisible(requires_hecatomb) end
          end

          local faction = cm:get_faction(faction_key)
          for i = 1, #tiers do
               local new_lock_component = UIComponent(tier_holder_component:CreateFromComponent(tier_template:Address(),
                                                                                                string.format(deities.component_ids.lock_instance_prefix .. i)))
               ...
               if hecatomb_button then
                    ...
                    if requires_hecatomb and (cooldown_remaining > 0 or not faction:can_afford_resource_cost_object(deities.get_hecatomb_cost(faction_key, god_key))) then
                         ...
                         if cooldown_remaining > 0 and hecatomb_cooldown_holder then
                              ...
                              if hecatomb_cooldown_text then hecatomb_cooldown_text:SetText(cooldown_remaining) end
                         end
                    else
                         hecatomb_button:SetState("active")
                         if hecatomb_cooldown_holder then hecatomb_cooldown_holder:SetVisible(false) end
                    end
               end
               ...
               if god_slot then
                    ...
                    if lock_favour_amount_component then lock_favour_amount_component:SetVisible(false) end
     ...
     init_tier_tooltip = function(component, god_key, tier)
          ...
          if tier <= deities.config.aten_first_tier_with_unlockables then
               ...
               if shrines_holder_component then shrines_holder_component:SetVisible(false) end
               if idols_holder_component then idols_holder_component:SetVisible(false) end
               if prayer_holder_component then prayer_holder_component:SetVisible(false) end
               if devoted_holder_component then devoted_holder_component:SetVisible(false) end
          end
               ...
               if unique_holder then
                    if tier >= deities.config.aten_first_tier_with_unlockables then
                         ...
                         if tier <= #aten_slot.unlockables_per_tier and aten_slot.unlockables_per_tier[tier].bundle then
                              if no_effect_text then no_effect_text:SetVisible(false) end
                              local effects_list = unique_holder:SequentialFind("effects_list")
                              if effects_list then effects_list:SetVisible(true) end
                              ...
                              if unique_holder_title_component then
                                   ...
                                   unique_holder_title_component:SetText(common.string_safe_format(blessing_effect_key_localised, unique_category_localised),
                                                                         blessing_effect_source)
                              end
     ...
     display_current_bonuses = function()
          ...
          if not tier_bonuses_component then return end
          ...
          if effects_title_component then effects_title_component:SetVisible(not is_worshipped) end
          ...
          if shrines_holder_component then shrines_holder_component:SetVisible(use_shrines) end
          local idols_holder_component = tier_bonuses_component:SequentialFind(deities.component_ids.idols_holder)
          if idols_holder_component then idols_holder_component:SetVisible(use_idols) end
          ...
          local tier = 0
          local bonuses = {shrine_bonuses = {}, idol_bonuses = {}, prayer_bonuses = {}, devoted_bonuses = {}, dwelling_bonuses = {}, unique_bonuses = {}}
          ...
          if use_shrines then deities.instantiate_bonuses(shrines_holder_component, bonuses.shrine_bonuses, tier >= deities.config.unlock_tiers.shrines) end
          if use_idols then deities.instantiate_bonuses(idols_holder_component, bonuses.idol_bonuses, tier >= deities.config.unlock_tiers.idols) end
          ...
          if shrines_icon then shrines_icon:SetState(tier >= deities.config.unlock_tiers.shrines and "unlocked" or "locked") end

          local idols_icon = idols_holder_component:SequentialFind(deities.component_ids.idols_icon)
          if idols_icon then idols_icon:SetState(tier >= deities.config.unlock_tiers.idols and "unlocked" or "locked") end
          local prayer_icon = prayer_holder_component:SequentialFind(deities.component_ids.prayer_icon)
          if prayer_icon then prayer_icon:SetState(tier >= deities.config.unlock_tiers.prayers and "unlocked" or "locked") end
          local prayer_description = prayer_holder_component:SequentialFind(deities.component_ids.prayer_description)
          if prayer_description then prayer_description:SetState(deities.is_sea_god(god_key) and "sea" or "default") end
          local devoted_icon = devoted_holder_component:SequentialFind(deities.component_ids.devoted_icon)
          if devoted_icon then devoted_icon:SetState(tier >= deities.config.unlock_tiers.devoted_generals and "unlocked" or "locked") end
          if use_dwellings then
               local dwellings_icon = dwellings_holder_component:SequentialFind(deities.component_ids.dwellings_icon)
               if dwellings_icon then dwellings_icon:SetState(tier >= deities.config.unlock_tiers.dwellings and "unlocked" or "locked") end
          end
     ...
     set_hecatomb_tooltip = function(component, faction_key, god_key)
          ...
          if not cco_table.SufficientResources then
               if cco_table.Warning ~= "" then cco_table.Warning = cco_table.Warning .. "\n" end
     ...
     instantiate_bonuses = function(holder, bonus_list, active)
          ...
          if not bonuses_holder then return end
          ...
          if bonus_list_component then bonus_list_component:SetVisible(#bonus_list > 0) end
     end,
     ...
     instantiate_unlockable_bonuses = function(shrines_holder, prayers_holder, devoted_holder, unique_holder)
          ...
          if shrines_aten_bonus_holder then shrines_aten_bonus_holder:DestroyChildren() end

          local prayers_aten_bonus_holder = prayers_holder:SequentialFind(deities.component_ids.aten_bonus_holder)
          if prayers_aten_bonus_holder then prayers_aten_bonus_holder:DestroyChildren() end

          local devoted_aten_bonus_holder = devoted_holder:SequentialFind(deities.component_ids.aten_bonus_holder)
          if devoted_aten_bonus_holder then devoted_aten_bonus_holder:DestroyChildren() end

          local uniqie_aten_bonus_holder = unique_holder:SequentialFind(deities.component_ids.aten_bonus_holder)
          if uniqie_aten_bonus_holder then uniqie_aten_bonus_holder:DestroyChildren() end
               ...
               for i = 1, #aten_slot.unlockables_per_tier do
                    ...
                    if current_unlockable then
                         if current_unlockable.category == deities.unlockable_categories.shrines and shrines_aten_bonus_holder then
                              new_unlockable_component = UIComponent(shrines_aten_bonus_holder:CreateFromComponent(aten_bonus_template:Address(),
                                                                                                                   deities.component_ids.aten_unlockable_prefix .. i))
                         elseif current_unlockable.category == deities.unlockable_categories.prayer and prayers_aten_bonus_holder then
                              new_unlockable_component = UIComponent(prayers_aten_bonus_holder:CreateFromComponent(aten_bonus_template:Address(),
                                                                                                                   deities.component_ids.aten_unlockable_prefix .. i))
                         elseif current_unlockable.category == deities.unlockable_categories.devoted_army and devoted_aten_bonus_holder then
                              new_unlockable_component = UIComponent(devoted_aten_bonus_holder:CreateFromComponent(aten_bonus_template:Address(),
                                                                                                                   deities.component_ids.aten_unlockable_prefix .. i))
                         elseif (current_unlockable.category == deities.unlockable_categories.unique or current_unlockable.category ==
                              deities.unlockable_categories.extra_general) and uniqie_aten_bonus_holder then
                              new_unlockable_component = UIComponent(uniqie_aten_bonus_holder:CreateFromComponent(aten_bonus_template:Address(),
                                                                                                                  deities.component_ids.aten_unlockable_prefix .. i))
                         end
                         ...
                         if new_unlockable_component then
                              ...
                              if tier_holder then tier_holder:SetText(deities.text_ids.roman_numerals[i]) end
     ...
     get_bonuses_for_tier = function(faction_key, god_key, tier, include_min_tiers, include_unlockables)
          local result = {shrine_bonuses = {}, idol_bonuses = {}, prayer_bonuses = {}, devoted_bonuses = {}, dwelling_bonuses = {}, unique_bonuses = {}}
          local faction_key = cm:get_local_faction_name(true)
          ...
          if use_shrines and tiers[shrine_tier].shrine_effect_bundles then
               for _, shrine_bundle in ipairs(tiers[shrine_tier].shrine_effect_bundles) do table.insert(result.shrine_bonuses, shrine_bundle.bundle) end
          end

          if use_idols and tiers[shrine_tier].idol_effect_bundles then
               for _, idol_bundle in ipairs(tiers[idol_tier].idol_effect_bundles) do table.insert(result.idol_bonuses, idol_bundle.bundle) end
          end
          if tiers[prayer_tier].prayer_effect_bundles then
               for _, prayer_bundle in ipairs(tiers[prayer_tier].prayer_effect_bundles) do table.insert(result.prayer_bonuses, prayer_bundle.bundle) end
          end
          if tiers[devoted_tier].devoted_effect_bundles then
               for _, devoted_bundle in ipairs(tiers[devoted_tier].devoted_effect_bundles) do table.insert(result.devoted_bonuses, devoted_bundle.bundle) end
          end
          ...
          if tier > 0 and tiers[tier].unique_effect_bundles and include_unlockables then
               for _, unique_bundle in ipairs(tiers[tier].unique_effect_bundles) do table.insert(result.unique_bonuses, unique_bundle.bundle) end
          end
               ...
               for i = 1, #aten_slot.unlockables_per_tier do
                    ...
                    if current_unlockable then
                         if current_unlockable.category == deities.unlockable_categories.shrines then
                              ...
                              if index then table.remove(result.shrine_bonuses, index) end
                         elseif current_unlockable.category == deities.unlockable_categories.prayer then
                              ...
                              if index then table.remove(result.prayer_bonuses, index) end
                         elseif current_unlockable.category == deities.unlockable_categories.devoted_army then
                              ...
                              if index then table.remove(result.devoted_bonuses, index) end
                         end
                    end
               end
          end
     ...
     get_inactive_aten_bonuses = function(faction_key)
          local result = {shrine_bonuses = {}, idol_bonuses = {}, prayer_bonuses = {}, devoted_bonuses = {}, unique_bonuses = {}}

          local aten_slot = deities.get_aten_slot(faction_key)
          if not aten_slot then return result end
          ...
          if is_table(aten_slot.unlockables_per_tier) then
               for i = tier + 1, #aten_slot.unlockables_per_tier do
                    ...
                    elseif current_unlockable.category == deities.unlockable_categories.unique or current_unlockable.category ==
                         deities.unlockable_categories.extra_general then
     ...
     display_religious_buildings = function()
          local apply_button = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.shrines_button_apply)
          if apply_button then apply_button:SetState("inactive") end

          for i = #deities.ui_data.shrine_radio_groups, 1, -1 do
               local nested_table = deities.ui_data.shrine_radio_groups[i]
               for j = #nested_table, 1, -1 do table.remove(nested_table, j) end
          ...
          if not shrines_holder then return end
          ...
          if not shrines_god_holder then return end
          ...
          for _, god_data in ipairs(god_slots) do
               if god_data.god_key and shrines_god_holder then
                    local new_god_component = UIComponent(shrines_god_holder:CreateFromComponent(god_ui_template:Address(), string.format(
                                                                                                      deities.component_ids.shrines_god_instance_prefix ..
                                                                                                           god_data.god_key)))
                    ...
                    if god_portrait_component and god and god.god_slot_image then god_portrait_component:SetImagePath(god.god_slot_image, 1) end
          ...
          if not toggle_template then return end
          ...
          if shrines_parent then
               ...
               if shrines_expanding_list_items then
                    ...
                    for i, god_data in ipairs(god_slots) do
                         if god_data.god_key then
                              for _, shrine_region in ipairs(god_data.shrine_regions) do
                                   deities.populate_religious_building_row(deities.religious_building_types.shrine, shrines_expanding_list_items, shrine_region, nil,
                                                                           god_slots, i, false)
                                   has_shrines = true
                              end
                              ...
                              if is_table(shrines_under_conversion) then
                                   for _, shrine in ipairs(shrines_under_conversion) do
                                        deities.populate_religious_building_row(deities.religious_building_types.shrine, shrines_expanding_list_items, shrine.region_key,
                                                                                nil, god_slots, i, true)
                                        has_shrines = true
                                   end
                              end
                         end
                    ...
                    if not has_shrines then
                         UIComponent(shrines_expanding_list_items:CreateFromComponent(deities.ui_data.templates.no_shrines_template:Address(),
                                                                                      deities.component_ids.no_shrines_text))
                    end
          ...
          if temples_parent then
               ...
               if temples_expanding_list_items then
                    ...
                    for i, god_data in ipairs(god_slots) do
                         if god_data.god_key then
                              for _, temple in ipairs(god_data.temples) do
                                   deities.populate_religious_building_row(deities.religious_building_types.temple, temples_expanding_list_items, temple.region_key, nil,
                                                                           god_slots, i, false)
                                   has_temples = true
                              end
                              ...
                              if is_table(temples_under_conversion) then
                                   for _, temple in ipairs(temples_under_conversion) do
                                        deities.populate_religious_building_row(deities.religious_building_types.temple, temples_expanding_list_items, temple.region_key,
                                                                                nil, god_slots, i, true)
                                        has_temples = true
                                   end
                              end
                    ...
                    if not has_temples then
                         UIComponent(temples_expanding_list_items:CreateFromComponent(deities.ui_data.templates.no_temples_template:Address(),
                                                                                      deities.component_ids.no_temples_text))
                    end
               ...
               if deities.faction_has_dwelling_gods(faction_key) then
                    ...
                    if dwellings_expanding_list_items then
                         ...
                         for i, god_data in ipairs(god_slots) do
                              if god_data.god_key then
                                   for _, dwelling_region in ipairs(god_data.dwelling_regions) do
                                        deities.populate_religious_building_row(deities.religious_building_types.dwelling, dwellings_expanding_list_items,
                                                                                dwelling_region, nil, god_slots, i, false)
                                        has_dwellings = true
                                   end
                                   ...
                                   if is_table(dwellings_under_conversion) then
                                        for _, dwelling in ipairs(dwellings_under_conversion) do
                                             deities.populate_religious_building_row(deities.religious_building_types.dwelling, dwellings_expanding_list_items,
                                                                                     dwelling.region_key, nil, god_slots, i, true)
                                             has_dwellings = true
                                        end
                                   end
                              end
                         ...
                         if not has_dwellings then
                              UIComponent(dwellings_expanding_list_items:CreateFromComponent(deities.ui_data.templates.no_dwellings_template:Address(),
                                                                                             deities.component_ids.no_dwellings_text))
                         end
               ...
               if deities.faction_has_access_to_idols(cm:get_local_faction_name(true)) then
                    ...
                    if idols_expanding_list_items then
                         ...
                         for i, god_data in ipairs(god_slots) do
                              if god_data.god_key then
                                   for _, idol in ipairs(god_data.idols) do
                                        deities.populate_religious_building_row(deities.religious_building_types.idol, idols_expanding_list_items, nil, idol.force_cqi,
                                                                                god_slots, i, false)
                                        has_idols = true
                                   end
                                   ...
                                   if is_table(idols_under_conversion) then
                                        for _, idol in ipairs(idols_under_conversion) do
                                             deities.populate_religious_building_row(deities.religious_building_types.idol, idols_expanding_list_items, nil,
                                                                                     idol.force_cqi, god_slots, i, true)
                                             has_idols = true
                                        end
                                   end
                              end
                         ...
                         if not has_idols then
                              UIComponent(idols_expanding_list_items:CreateFromComponent(deities.ui_data.templates.no_idols_template:Address(),
                                                                                         deities.component_ids.no_idols_text))
                         end
          ...
          for column_index = 1, colummns do
               if god_slots[column_index].god_key then
                    ...
                    if idol_chain and idol_chain ~= "" then
                         ...
                         local force_list = faction:military_force_list()
                         for i = 0, force_list:num_items() - 1 do
                              if set_inactive then break end
                              local force = force_list:item_at(i)
                              local force_slots = force:slots()
                              if force_slots then
                                   local last_slot_index = force_slots:num_items() - 1
                         ...
                         if is_table(conversion_table) and not table.is_empty(conversion_table) then set_inactive = true end

                         for row_index = 1, #deities.ui_data.idol_radio_groups do
                              local row = deities.ui_data.idol_radio_groups[row_index].components
                              if row_index ~= selected_row then row[column_index]:SetState(set_inactive and "inactive" or "active") end
                         end
                    end
               end
          end
     ...
     set_religious_building_counters = function(god_component, god_data)
          ...
          if shrines_god_template_shrines_holder then
               if god_config.shrine_chain and god_config.shrine_chain ~= "" then
                    ...
                    local shrines_god_template_shrines_count =
                         shrines_god_template_shrines_holder:SequentialFind(deities.component_ids.shrines_god_template_shrines_count)
                    if shrines_god_template_shrines_count then shrines_god_template_shrines_count:SetText(#god_data.shrine_regions) end
               else
          ...
          if shrines_god_template_temples_holder then
               if god_config.temple_chain and god_config.temple_chain ~= "" then
                    ...
                    local shrines_god_template_temples_count =
                         shrines_god_template_temples_holder:SequentialFind(deities.component_ids.shrines_god_template_temples_count)
                    if shrines_god_template_temples_count then shrines_god_template_temples_count:SetText(#god_data.temples) end
               else
          ...
          if shrines_god_template_dwellings_holder then
               if god_config.dwelling_chain and god_config.dwelling_chain ~= "" then
                    ...
                    local dwellings_god_template_temples_count = shrines_god_template_dwellings_holder:SequentialFind(deities.component_ids
                                                                                                                           .shrines_god_template_dwellings_count)
                    if dwellings_god_template_temples_count then dwellings_god_template_temples_count:SetText(#god_data.dwelling_regions) end
               else
          ...
          if shrines_god_template_idols_holder then
               if god_config.idol_chain and god_config.idol_chain ~= "" then
                    ...
                    if shrines_god_template_idols_count then shrines_god_template_idols_count:SetText(#god_data.idols) end
               else
     ...
     populate_religious_building_row = function(building_type, expanding_list_items, region_key, force_cqi, god_slots, selected_god_slot_index, is_converting)
          ...
          if location_text then
               if building_type == deities.religious_building_types.shrine or building_type == deities.religious_building_types.temple or building_type ==
                    deities.religious_building_types.dwelling then
          ...
          if location_name then
               ...
               if region_key then
                    local region = cm:get_region(region_key)
                    if region and not region:is_null_interface() then cco_table.Title = region:localised_display_name() end
               elseif force_cqi then
                    local force = cm:get_military_force_by_cqi(force_cqi)
                    local general
                    if force then general = force:general_character() end
                    if general then cco_table.Title = general:onscreen_name() end
               end
               cco_table.Action = common.get_localised_string("ui_text_replacements_localised_text_" .. deities.text_ids.shrine_or_temple_tooltip.click)
               if is_converting then
                    if building_type == deities.religious_building_types.shrine then
                         cco_table.Alert = common.get_localised_string("ui_text_replacements_localised_text_" ..
                                                                            deities.text_ids.shrine_or_temple_tooltip.shrine_conversion)
                    elseif building_type == deities.religious_building_types.temple then
                         cco_table.Alert = common.get_localised_string("ui_text_replacements_localised_text_" ..
                                                                            deities.text_ids.shrine_or_temple_tooltip.temple_conversion)
                    elseif building_type == deities.religious_building_types.dwelling then
                         cco_table.Alert = common.get_localised_string("ui_text_replacements_localised_text_" ..
                                                                            deities.text_ids.shrine_or_temple_tooltip.dwelling_conversion)
                    elseif building_type == deities.religious_building_types.idol then
                         cco_table.Alert =
                              common.get_localised_string("ui_text_replacements_localised_text_" .. deities.text_ids.shrine_or_temple_tooltip.idol_conversion)
                    end
               end
               local script_id
               if building_type == deities.religious_building_types.shrine then
          ...
          if is_converting then
               ...
               if location_text_component then location_text_component:SetState("converting") end
          ...
          if not radio_button_template then return end
          ...
          if toggle_holder_component then
               ...
               local radio_group = {region_key = region_key, force_cqi = force_cqi, originally_selected_god_key = selected_god_key, components = {}}
               ...
               for _, god_data in ipairs(god_slots) do
                    if god_data.god_key then
                         local new_toggle_component = UIComponent(toggle_holder_component:CreateFromComponent(deities.ui_data.templates.shrines_toggle_template:Address(),
                                                                                                              string.format(toggle_intance_prefix .. god_data.god_key)))
                         ...
                         if radio_button then
                              ...
                              if god_data.god_key == selected_god_key then radio_button:SetState("selected") end
     ...
     update_religious_buildings_group_cost_and_time = function(radio_group, get_chain_function, get_level_function, building_id, total_resource_cost, max_conversion_time)
          ...
          for index, current_radio_group in ipairs(radio_group) do
               ...
               if selected_god_key ~= current_radio_group.originally_selected_god_key then
                    ...
                    local level = 0
                    if get_level_function then level = get_level_function(local_faction_key, current_radio_group[building_id]) end
                    ...
                    if bonus_value ~= 0 then current_resource_cost:multiply_by((100.0 + bonus_value) / 100.0) end
                    total_resource_cost:add(current_resource_cost)
     ...
     religious_buildings_refresh_cost_and_time = function()
          local resources_holder = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.resources_holder)

          if not (resources_holder and deities.ui_data.templates.resource_template) then return end
          ...
          total_resource_cost, max_conversion_time = deities.update_religious_buildings_group_cost_and_time(shrines_radio_groups, deities.get_god_shrine_chain, nil, nil,
                                                                                                            total_resource_cost, max_conversion_time)
          total_resource_cost, max_conversion_time = deities.update_religious_buildings_group_cost_and_time(temple_radio_groups, deities.get_god_temple_chain,
                                                                                                            deities.get_temple_level, "region_key", total_resource_cost,
                                                                                                            max_conversion_time)
          total_resource_cost, max_conversion_time = deities.update_religious_buildings_group_cost_and_time(dwelling_radio_groups, deities.get_god_dwelling_chain, nil,
                                                                                                            nil, total_resource_cost, max_conversion_time)
          total_resource_cost, max_conversion_time = deities.update_religious_buildings_group_cost_and_time(idols_radio_groups, deities.get_god_idol_chain,
                                                                                                            deities.get_idol_level, "force_cqi", total_resource_cost,
                                                                                                            max_conversion_time)
          ...
          for index, resource in ipairs(resources) do
               local new_resource_component = UIComponent(resources_holder:CreateFromComponent(deities.ui_data.templates.resource_template:Address(),
                                                                                               deities.component_ids.resources_prefix .. index))
          ...
          local cost_container = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.resources_cost_container)
          if cost_container then cost_container:SetVisible((not table.is_empty(resources)) and max_conversion_time > 0) end

          local turns_component = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.conversion_turns)
          if turns_component then turns_component:SetText(max_conversion_time) end

          local apply_button = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder, deities.component_ids.shrines_button_apply)
          if not apply_button then return end
     ...
     close_religious_buidings = function()
          local shrines_and_temples_holder = deities.panel:SequentialFind(deities.component_ids.shrines_and_temples_holder)
          if shrines_and_temples_holder then shrines_and_temples_holder:SetVisible(false) end
     end,

     deselect_all = function() deities.close_religious_buidings() end,
     ...
     setup_favoured_god_ui_script_object = function()
          ...
          local ui_table = {god_key = favoured_god_key, tooltip_title = tooltip_title, tooltip_text = tooltip_text, icon = icon}
     ...
     ------------------------AKHENATEN UI -------------------------
     --------------------------------------------------------------
     toggle_aten_creation_panel_visibility = function(visible) common.set_context_value(deities.context_values.show_create_aten_panel, visible and 1 or 0) end,

     toggle_aten_panel_visibility = function(visible) common.set_context_value(deities.context_values.show_aten_panel, visible and 1 or 0) end,

     toggle_aten_unlocks_visibility = function(visible) common.set_context_value(deities.context_values.show_aten_unlocks, visible and 1 or 0) end,
     ...
     fill_create_aten_gods = function()
          if not (deities.ui_data.templates.aten_creation_god_template and deities.ui_data.templates.aten_god_creation_god_holder) then return end
          local aten_creation_component = deities.panel:SequentialFind(deities.component_ids.aten_creation)
          if not aten_creation_component then return end
          ...
          for i = #deities.ui_data.aten_creation_god_components, 1, -1 do table.remove(deities.ui_data.aten_creation_god_components, i) end
          ...
          if aten_index then table.remove(discovered_gods, aten_index) end
          ...
          if #discovered_gods > 0 then
               ...
               for i, god_key in ipairs(discovered_gods) do
                    ...
                    if god_counter % 5 == 1 then
                         last_god_holder = UIComponent(aten_pool_and_effects_list_box:CreateFromComponent(
                                                            deities.ui_data.templates.aten_god_creation_god_holder:Address(),
                                                            deities.component_ids.aten_creation_god_holder_prefix .. i))
                    end
                    local god = deities.get_god(god_key)
                    if god and not deities.is_sea_god(god_key) then
                         ...
                         deities.ui_data.templates.aten_creation_god_template:SetProperty("script_id",
                                                                                          deities.context_values.create_aten_god_table_prefix .. tostring(god_key))
                         common.set_context_value(deities.context_values.create_aten_god_table_prefix .. tostring(god_key), cco_god_table)

                         local new_god_component = UIComponent(last_god_holder:CreateFromComponent(deities.ui_data.templates.aten_creation_god_template:Address(),
                                                                                                   deities.component_ids.aten_creation_god_prefix .. tostring(god_key)))
     ...
     choose_aten_god = function(context)
          ...
          if not god_component then return end
     ...
     update_aten_gods = function(context)
          ...
          if deities.ui_data.aten_god_1 then
               ...
               if god then
                    ...
                    if slot_1_component then slot_1_component:SetState("selected") end
               end
          else
               ...
               if slot_1_component then slot_1_component:SetState("default") end
          end
          ...
          if deities.ui_data.aten_god_2 then
               ...
               if god then
                    ...
                    if slot_2_component then slot_2_component:SetState("selected") end
               end
          else
               -- for changing the visibility of the X button
               ...
               if slot_2_component then slot_2_component:SetState("default") end
          end
          ...
          if deities.ui_data.aten_god_1 and deities.ui_data.aten_god_2 then
               ...
               for _, button in ipairs(deities.ui_data.aten_creation_god_components) do deities.set_god_card_active(button, false) end
          else
               common.set_context_value(deities.context_values.confirm_create_aten_active, 0)

               for _, button in ipairs(deities.ui_data.aten_creation_god_components) do deities.set_god_card_active(button, true) end
          end
     ...
     update_aten_gods_effects = function()
          ...
          if not aten_bonus_effects_list_holder then return end
          ...
          if not (deities.ui_data.templates.aten_shrines_effects_holder_template and deities.ui_data.templates.aten_prayers_effects_holder_template and
               deities.ui_data.templates.aten_devoted_armies_effects_holder_template) then return end
          ...
          if not_enough_gods_warning then not_enough_gods_warning:SetVisible(not to_bool(gods[1] and gods[2])) end
          ...
          for i = 1, 2 do
               ...
               if god then
                    local tiers = deities.get_god_tiers(faction_key, god.key)
                    if potential_tier > #tiers then potential_tier = #tiers end
          ...
          if deities.ui_data.templates.aten_shrines_effects_holder_template and #combined_shrine_effect_bundles > 0 then
               local new_shrine_effects_holder = UIComponent(aten_bonus_effects_holder_list_box:CreateFromComponent(deities.ui_data.templates
                                                                                                                         .aten_shrines_effects_holder_template:Address(),
                                                                                                                    deities.component_ids
                                                                                                                         .aten_bonus_effects_shrines_holder_prefix))
          ...
          if deities.ui_data.templates.aten_prayers_effects_holder_template and #combined_prayer_effect_bundles > 0 then
               local new_prayer_effects_holder = UIComponent(aten_bonus_effects_holder_list_box:CreateFromComponent(deities.ui_data.templates
                                                                                                                         .aten_prayers_effects_holder_template:Address(),
                                                                                                                    deities.component_ids
                                                                                                                         .aten_bonus_effects_prayers_holder_prefix))
          ...
          if deities.ui_data.templates.aten_devoted_armies_effects_holder_template and #combined_devoted_effect_bundles > 0 then
               local new_devoted_armies_effects_holder = UIComponent(aten_bonus_effects_holder_list_box:CreateFromComponent(deities.ui_data.templates
                                                                                                                                 .aten_devoted_armies_effects_holder_template:Address(),
                                                                                                                            deities.component_ids
                                                                                                                                 .aten_bonus_effects_devoted_armies_holder_prefix))
     ...
     confirm_create_aten = function()
          ...
          create_confirmation_box_with_text_from_script("confirmation_box", description_localised, description_source, -- Confirm
          function()
               local local_faction_cqi = cm:get_faction(cm:get_local_faction_name(true)):command_queue_index()
          ...
          nil, nil, title_localised, title_source)
     end,

     confirm_select_unlockable = function()
          if not deities.ui_data.aten_selected_unlockable then return end
          ...
          function()
               local local_faction_cqi = cm:get_faction(cm:get_local_faction_name(true)):command_queue_index()
               CampaignUI.TriggerCampaignScriptEvent(local_faction_cqi,
                                                     "PharLocalDeities_SelectUnlockable:" .. selected_choice.bundle.bundle .. ":" .. selected_choice.category)
          end, -- Cancel
          function() deities.display_unlockables() end, nil, title_localised, title_source)
     end,

     display_unlockables = function()
          if not deities.ui_data.templates.aten_unlockable then return end

          local aten_unlockables_holder = deities.panel:SequentialFind(deities.component_ids.aten_unlockables_holder)
          if not aten_unlockables_holder then return end
          ...
          if not aten_unlockables_holder_list_box then return end
          ...
          for i = #deities.ui_data.aten_unlockables_components, 1, -1 do table.remove(deities.ui_data.aten_unlockables_components, i) end
          ...
          if is_table(choices) then
               for i, choice in ipairs(choices) do
                    local unlockable_component = UIComponent(aten_unlockables_holder_list_box:CreateFromComponent(deities.ui_data.templates.aten_unlockable:Address(),
                                                                                                                  deities.component_ids.aten_unlockable_prefix .. i))
                    ...
                    if locked_overlay then locked_overlay:SetProperty("index", i) end
                    ...
                    if flavour_text then
                         ...
                         if localised_text then flavour_text:SetText(localised_text.flavour_localised, localised_text.flavour_source) end
                    end
               end
          end
     ...
     update_local_deities_notification = function()
          ...
          if not alert_component then return end

          local faction_key = cm:get_local_faction_name(true)
          -- no local faction means autorun
          if faction_key == false then return end
          ...
          if faction_has_unlocked_feature then
               ...
               if is_tutorial and not tn_listeners_triggered.per_amun_conquered then return end
     ...
     on_god_clicked = function(god_key)
          if not god_key or god_key == "" then return end
     ...
     on_back_unlockables_clicked = function() deities.open_aten() end,

     on_back_aten_creation = function() deities.display_god_slots() end,

     on_previous_clicked = function() deities.cycle_selected_god(-1) end,

     on_next_clicked = function() deities.cycle_selected_god(1) end,
     ...
     on_hecatomb_clicked = function()
          ...
          create_confirmation_box_with_text_from_script("confirmation_box", localised_text, text_source, -- Confirm
          function() CampaignUI.TriggerCampaignScriptEvent(local_faction_cqi, "PharLocalDeities_Hecatomb:" .. deities.ui_data.selected_god) end, -- Cancel
          nil, nil, "", "")
     end,
     ...
     cycle_selected_god = function(offset)
          ...
          if deities.has_faction_created_aten(faction_key) then table.insert(all_ordered_gods, deities.get_god(deities.config.aten_god_key)) end

          for _, culture in ipairs(deities.config.cultures) do table_append(all_ordered_gods, deities.get_ordered_gods(faction_key, culture)) end
     ...
     on_worship_clicked = function(context)
          ...
          if not is_table(deities.persistent[faction_key]) then deities.output("Could not get deities data for faction " .. tostring(faction_key) .. "!", 10) end
     ...
     display_worship_dialogue = function(free_slot_index)
          ...
          create_confirmation_box_with_text_from_script(deities.component_ids.worship_dialogue_box_id, localised_description, description_source, -- Confirm
          function(context)
               local local_faction_key = cm:get_local_faction_name(true)
               local local_faction_cqi = cm:get_faction(local_faction_key):command_queue_index()
          ...
          function(context) deities.toggle_worship_button_visible(true) end, panel, localised_title, title_source)
          ...
          if result_template then
               ...
               local add_result = function(text_record, additional_text_record)
                    ...
                    if additional_text_record then
                         ...
                         localised_text = common.string_safe_format(common.get_localised_string(source), common.get_localised_string(additional_text_source),
                                                                    localised_god_name)
                    else
                         localised_text = common.string_safe_format(common.get_localised_string(source), localised_god_name)
                    end
                    local new_result_component = UIComponent(result_parent:CreateFromComponent(result_template:Address(),
                                                                                               deities.component_ids.worship_result_prefix .. result_index))
               ...
               if is_string(shrine_chain) and shrine_chain ~= "" then -- Has shrines and prays at them.
                    ...
                    if deities.config.unlock_tiers.prayers == 1 then add_result(deities.component_ids.worship_dialogue_prayers) end
               end
               ...
               if is_string(idol_chain) and idol_chain ~= "" then -- Has idols and prays at nomad outposts.
                    ...
                    if deities.config.unlock_tiers.idols == 1 then add_result(deities.component_ids.worship_dialogue_idols) end

                    if deities.config.unlock_tiers.prayers == 1 then add_result(deities.component_ids.worship_dialogue_prayers_nomad_outpost) end
               end

               if deities.config.unlock_tiers.devoted_generals == 1 then add_result(deities.component_ids.worship_dialogue_devoted) end
          end
     end,
     ...
     display_rededication_dialogue = function()
          ...
          if title_component then title_component:SetText(localised_title, title_source) end
          ...
          if gods_holder and god_template then
               ...
               for i, god_data in ipairs(deities.persistent[faction_key].god_slots) do
                    if god_data.god_key then
                         local new_god_component = UIComponent(gods_holder:CreateFromComponent(god_template:Address(),
                                                                                               deities.component_ids.rededicate_god_template_instance_prefix .. i))
               ...
               if #deities.ui_data.gods_for_rededication == 1 then
                    ...
                    deities.ui_data.selected_god_for_rededication = deities.ui_data.gods_for_rededication[1]:GetProperty(deities.component_ids
                                                                                                                              .rededicate_god_template_god_slot_property)
               end
          end
          ...
          if result_template then
               ...
               local add_result = function(text_record, state)
                    if not result_parent then return end
                    local source = "ui_text_replacements_localised_text_" .. text_record
          ...
          if cost_text then cost_text:SetState(deities.is_sea_god(current_god_key) == deities.is_sea_god(god_key) and "default" or "refund") end
     ...
     display_rededication_cost_and_time = function(dialogue_component, selected_god_key)
          ...
          if worship_button then worship_button:SetState(selected_god_key and "active" or "inactive") end
          ...
          if not conversion_cost or #conversion_cost:resources() == 0 then
               ...
               if resources_cost_holder then resources_cost_holder:SetVisible(false) end
               if resources_label then resources_label:SetVisible(false) end
               return
          else
               if resources_cost_holder then resources_cost_holder:SetVisible(true) end
               if resources_label then resources_label:SetVisible(true) end
          end

          local resources_holder = dialogue_component:SequentialFind(deities.component_ids.resources_holder)
          if not resources_holder then return end
          ...
          if turns_component then turns_component:SetText(conversion_time) end
     ...
     get_rededication_cost_and_time = function(faction_key, god_key)
          local god_slot = deities.get_god_slot(faction_key, god_key)
          if not god_slot then return nil, 0 end
     ...
     on_culture_tab_clicked = function(context) deities.deselect_all() end,
     ...
     on_army_button_clicked = function(context)
          ...
          if not clicked_component then return end

          local state = clicked_component:CurrentState()
          if string.find(clicked_component:CurrentState(), "locked") then return end
          ...
          if not army_selector_holder then return end
          ...
          if not army_selector_component then return end
          ...
          if not army_ui_template then return end

          if not string.find(clicked_component:CurrentState(), "available") then return end
          ...
          for i = 0, characters_list:num_items() - 1 do
               ...
               if character:character_type("general") and not character:family_member():is_convalescing() then
                    ...
                    for slot_index = 1, deities.get_faction_god_slots_count(faction_key) do
                         if already_devoted then break end
                    ...
                    if not already_devoted then
                         ...
                         local is_obedience_army = character:has_military_force() and character:military_force():force_type() ==
                                                        eminence.config.obedience.spawned_army_force_type
                         if not is_obedience_army then
                              local cco_character = cco("CcoCampaignCharacter", character:command_queue_index())
                              local new_army_component = UIComponent(army_selector_component:CreateFromComponent(army_ui_template:Address(),
                                                                                                                 deities.component_ids.army_prefix .. i))
          ...
          if no_generals_text_template and characters_displayed == 0 then
               local no_generals_text =
                    UIComponent(army_selector_component:CreateFromComponent(no_generals_text_template:Address(), deities.component_ids.no_general_txt))
     ...
     hide_army_selectors = function()
          for _, component in ipairs(deities.ui_data.god_slot_army_button_components) do
               ...
               if current_army_selector_component then current_army_selector_component:SetVisible(false) end
          end
     end,
     ...
     on_general_clicked = function(context)
          ...
          if not god_slot_index then return end
          ...
          if not devoted_general_index then return end
          ...
          create_confirmation_box_with_text_from_script("confirmation_box", description_localised, description_source, -- Confirm
          function()
               CampaignUI.TriggerCampaignScriptEvent(local_faction_cqi, "PharLocalDeities_AssignDevotedGeneral:" .. tostring(god_key) .. ":" .. devoted_general_index ..
                                                          ":" .. family_member_cqi)
     ...
     on_religious_buildings_button_clicked = function(context)
          ...
          if not button_component then return end
     ...
     apply_radio_group_changes = function(radio_groups, event)
          for _, current_radio_group in ipairs(radio_groups) do
               ...
               if selected_god_key and selected_god_key ~= current_radio_group.originally_selected_god_key then
                    ...
                    CampaignUI.TriggerCampaignScriptEvent(local_faction_cqi,
                                                          event .. ":" .. location .. ":" .. current_radio_group.originally_selected_god_key .. ":" .. selected_god_key)
               end
          end
     end,
     ...
     rededication_panel_close = function()
          local dialogue_component = deities.panel:SequentialFind(deities.component_ids.rededicate_dialogue)
          if dialogue_component then dialogue_component:SetVisible(false) end
          deities.ui_data.selected_god_for_rededication = nil
     ...
     on_god_for_rededication_clicked = function(context)
          ...
          for _, god_component in ipairs(deities.ui_data.gods_for_rededication) do if god_component ~= component then god_component:SetState("active") end end
     end,

     on_rededication_confirm = function()
          if deities.ui_data.selected_god_for_rededication then
               local local_faction_cqi = cm:get_faction(cm:get_local_faction_name(true)):command_queue_index()
               CampaignUI.TriggerCampaignScriptEvent(local_faction_cqi, "PharLocalDeities_WorshipGod_" .. deities.ui_data.selected_god .. "_slot_" ..
                                                          deities.ui_data.selected_god_for_rededication)
          end
          deities.rededication_panel_close()
          deities.toggle_worship_button_visible(false)
...
deities.ui_set_army_id_devoted_icon = function(family_member_cqi, visible, god_key)
     ...
     if character_family_member:is_null_interface() then
          out("Family member with CQI " .. family_member_cqi .. " does not exist!")
          return
     end

     local character = character_family_member:character()
     if character:is_null_interface() then
          out("character with Family member with CQI " .. family_member_cqi .. " does not exist!")
          return
     end

     local military_force = character:military_force()
     if military_force:is_null_interface() then
          out("military force for character with Family member with CQI " .. family_member_cqi .. " does not exist!")
          return
     end
     ...
     if visible then
          local god_name_loc_key = deities.get_localised_text(god_key).name_source
          cm:set_custom_army_info_icon(cqi, "icon_devoted", "", "devoted_general", "devoted_general_descr_format", 0, 0, 0, god_name_loc_key)
     else
          cm:set_custom_army_info_icon_visibility(cqi, "icon_devoted", false)
     end
end

deities.ui_on_devoted_general = function(faction_key, family_member_cqi, god_key) deities.ui_set_army_id_devoted_icon(family_member_cqi, true, god_key) end

deities.ui_on_remove_devoted_general = function(faction_key, family_member_cqi) deities.ui_set_army_id_devoted_icon(family_member_cqi, false) end
     ...
     for faction_key, v in pairs(deities.persistent) do
          ...
          for god_slot_idx, god_slot in ipairs(god_slots) do
               for idx, cqi in pairs(god_slot.devoted_generals_family_member_cqi) do
                    if cqi then deities.ui_set_army_id_devoted_icon(cqi, true, god_slot.god_key) end
               end
          end
     end
end
...
deities.check_and_update_UI_button = function(faction_key)
     ...
     if core:svr_load_bool("sbool_player_selected_first_turn_intro_on_frontend") or cm:get_saved_value("bool_is_tutorial_mode") then return end
     ...
     if turn_number < feature_turn then
          ...
          local description_param = {{text = description_key, params = {feature_available_turn}}}
...
vo_events = {worship = "campaign_vo_localdeities_worship", assign_devotee = "campaign_vo_localdeities_devote_assign"}
...
-- Fill starting gods
core:add_listener("PharLocalDeities_NewCampaignStarted", "NewCampaignStarted", true, function(context)
...
core:add_listener("PharLocalDeities_FirstTickAfterWorldCreated", "FirstTickAfterWorldCreated", true, function(context)
...
core:add_listener("PharLocalDeities_SettlementOccupation", "CharacterPerformsSettlementOccupationDecision",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     ...
     if context:character():faction():is_allowed_to_capture_territory() == false or
          (occupation_decision == "occupation_decision_occupy" or occupation_decision == "occupation_decision_loot" or occupation_decision ==
               "occupation_decision_colonise") then
          local discovered_gods = deities.discover_gods_for_region(context:character():faction():name(), region:name())
          if context:character():faction():name() == cm:get_local_faction_name(true) then deities.display_discovered_god_animation(discovered_gods) end
     end
end, true)

-- Discover gods after subjugation - both sides discover the gods from each other's regions
-- include vassalage for completeness
core:add_listener("PharLocalDeities_PositiveDiplomaticEvent", "PositiveDiplomaticEvent", function(context) return context:is_vassalage() or context:is_subjugation() end,
                  function(context)
     ...
     for i = 0, recepient_region_list:num_items() - 1 do
          ...
          if proposer_faction:name() == cm:get_local_faction_name(true) then deities.display_discovered_god_animation(discovered_gods) end
     end
     ...
     for i = 0, proposer_region_list:num_items() - 1 do
          ...
          if recipient_faction:name() == cm:get_local_faction_name(true) then deities.display_discovered_god_animation(discovered_gods) end
     end
end, true)

core:add_listener("PharLocalDeities_SettlementOccupationDecisionBeforeOutcomeApplication", "CharacterPerformsSettlementOccupationDecisionBeforeOutcomeApplication",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local occupation_decision = context:occupation_decision_option()
     ...
     if (occupation_decision == "occupation_decision_occupy" or occupation_decision == "occupation_decision_loot" or occupation_decision == "occupation_decision_colonise") and
          region:name() == deities.get_god_cult_centre_region(deities.config.aten_god_key) then
          ...
          if deities.has_faction_claimed_akhenaten(old_owner_key) then
               deities.add_deities_event_message("ancient_legacy_aten_amarna_lost", old_owner_key, 0, region:name(),
                                                 cm:char_lookup_str(context:character():command_queue_index()))
          end
          if deities.has_faction_claimed_akhenaten(new_owner_key) then
               deities.add_deities_event_message("ancient_legacy_aten_amarna_captured", new_owner_key, 0, region:name(),
                                                 cm:char_lookup_str(context:character():command_queue_index()))
...
core:add_listener("PharLocalDeities_RegionFactionChangeEvent", "RegionFactionChangeEvent",
                  function(context) return context:region():owning_faction():is_pharaoh_game_faction() end, function(context)
     ...
     if reason == "diplomacy trade" or reason == "campaign director" then
          ...
          if new_faction == cm:get_local_faction_name(true) then deities.display_discovered_god_animation(discovered_gods) end
     end
     ...
     for i = 0, region_slots:num_items() - 1 do
          local slot = region_slots:item_at(i)
          local building = slot:building()
          if building and not building:is_null_interface() then deities.transfer_building(building, region_key, previous_faction, new_faction) end
     end
     ...
     if cult_centre_region_key ~= "" and region:name() == cult_centre_region_key then
          ...
          if new_owner_aten_tier > 0 then deities.update_unique_effects(new_faction, 0, new_owner_aten_tier) end

          local previous_owner_aten_tier = deities.get_tier(previous_faction, deities.config.aten_god_key)
          if previous_owner_aten_tier > 0 then deities.remove_aten_cult_centre_effects(previous_faction) end
     end
end, true)

core:add_listener("PharLocalDeities_ResearchCompleted", "ResearchCompleted", function(context) return context:faction():name() == cm:get_local_faction_name(true) end,
                  function(context) deities.update_local_deities_notification() end, true)

core:add_listener("PharLocalDeities_FactionTurnEnd", "FactionTurnEnd", function(context) return context:faction():is_pharaoh_game_faction() end, function(context)
...
core:add_listener("PharLocalDeities_FactionTurnStart", "FactionTurnStart", function(context)
     ...
     if not is_number(deities.ui_persistent.last_round_god_discovered) then
          -- for save migration
          deities.ui_persistent.last_round_god_discovered = cm:model():turn_number()
     elseif deities.ui_persistent and is_table(deities.ui_persistent.newly_discovered_gods) and #deities.ui_persistent.newly_discovered_gods > 0 then
          ...
          if turns_since_last_discovered >= turns_visible and turns_since_unlocked >= turns_visible then deities.ui_persistent.newly_discovered_gods = {} end
     end
...
core:add_listener("PharLocalDeities_BuildingConstructionStarted", "BuildingConstructionStarted",
                  function(context) return context:garrison_residence():faction():is_pharaoh_game_faction() end, function(context)
     local garrison_residence = context:garrison_residence()
     if not garrison_residence:is_slot() then return end
     ...
     if not (old_building and not old_building:is_null_interface()) then return end
...
core:add_listener("PharLocalDeities_CharacterMilitaryForceBuildingConstructionStarted", "CharacterMilitaryForceBuildingConstructionStarted",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end

     local old_building_chain = context:old_building_chain()
     if old_building_chain == "" then return end
     ...
     if old_idol_god then
          ...
          if not idol_under_conversion then
               ...
               -- If the gods are the same we are upgrading, not converting
               if new_idol_god and new_idol_god ~= old_idol_god then deities.find_and_change_idol_god(faction_key, new_idol_god.key, force_cqi) end
          end
     end
end, true, true)

-- cancel building temples, shrines and dwellings
core:add_listener("PharLocalDeities_BuildingConstructionCanceled", "BuildingConstructionCanceled",
                  function(context) return context:garrison_residence():faction():is_pharaoh_game_faction() end, function(context)
     local garrison_residence = context:garrison_residence()
     if garrison_residence:is_slot() then
          ...
          if building and not building:is_null_interface() then
               ...
               if temple_god then
                    ...
                    if temple_under_conversion then deities.cancel_temple_conversion(faction_key, temple_god.key, region_key) end
               end
...
core:add_listener("PharLocalDeities_CharacterMilitaryForceBuildingConstructionCanceled", "CharacterMilitaryForceBuildingConstructionCanceled",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end
     ...
     if building_chain == "" then return end
     ...
     if idol_god then deities.cancel_idol_conversion(faction_key, force_cqi) end
end, true, true)

-- build (or upgrade) temples, shrines and dwellings
core:add_listener("PharLocalDeities_BuildingCompleted", "BuildingCompleted", function(context) return context:building():faction():is_pharaoh_game_faction() end,
                  function(context)
     ...
     if cult_centre_god then deities.add_cult_centre(faction_key, cult_centre_god.key) end
end, true)

-- build (or upgrade) idols
core:add_listener("PharLocalDeities_CharacterMilitaryForceBuildingCompleted", "CharacterMilitaryForceBuildingCompleted",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end
...
core:add_listener("PharLocalDeities_BuildingDemolished", "BuildingDemolished", function(context) return context:building():faction():is_pharaoh_game_faction() end,
                  function(context)
     local building = context:building()
     local building_chain = building:chain()
     local faction_key = building:faction():name()
     ...
     local cult_centre_god = table_find(deities.gods, function(e) return building_chain == e.cult_centre_chain end)
     -- building is a cult centre grand temple
     if cult_centre_god then deities.remove_cult_centre(faction_key, cult_centre_god.key) end
end, true)

-- demolish idols
core:add_listener("PharLocalDeities_CharacterMilitaryForceBuildingDemolished", "CharacterMilitaryForceBuildingDemolished",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end
...
-- building repaired
core:add_listener("PharLocalDeities_BuildingRepaired", "CampaignBuildingRepaired", true, function(context)
     local garrison_residence = context:garrison_residence()
     if garrison_residence:is_slot() then
          local slot = garrison_residence:slot_interface()
          local region_key = garrison_residence:region():name()
          ...
          local cult_centre_god = table_find(deities.gods, function(e) return building_chain == e.cult_centre_chain end)
          if cult_centre_god then deities.update_cult_centre_favour(faction_key, cult_centre_god.key) end
     end
end, true)

-- force building repaired
core:add_listener("PharLocalDeities_CharacterMilitaryForceBuildingRepaired", "CharacterMilitaryForceBuildingRepaired",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end
     ...
     local building_chain = building:chain()
     local idol_god = table_find(deities.gods, function(e) return building_chain == e.idol_chain end)
     if idol_god then deities.update_idol_favour(faction_key, idol_god.key) end
end, true, true)

-- building damaged
core:add_listener("PharLocalDeities_BuildingDamaged", "CampaignBuildingDamaged", true, function(context)
     local garrison_residence = context:garrison_residence()
     if garrison_residence:is_slot() then
          local slot = garrison_residence:slot_interface()
          local region_key = garrison_residence:region():name()
...
core:add_listener("PharLocalDeities_RegionAboutToBeAbandoned", "RegionAboutToBeAbandoned", true, function(context)
     local region = context:region()
     ...
     for i = 0, region_slots:num_items() - 1 do
          local slot = region_slots:item_at(i)
          local building = slot:building()
          if building and not building:is_null_interface() then deities.transfer_building(building, region:name(), faction_key, "rebels") end
     end
end, true)

-- force building damaged
core:add_listener("PharLocalDeities_CharacterCampaignBuildingDamaged", "CharacterMilitaryForceBuildingDamaged",
                  function(context) return context:character():faction():is_pharaoh_game_faction() end, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end
...
-- general recruited
core:add_listener("PharLocalDeities_NewCharacterRecruited", "NewCharacterRecruited", true, function(context)
...
core:add_listener("PharLocalDeities_CharacterFactionChange", "CharacterFactionChange", true, function(context)
     ...
     for i = 1, deities.get_faction_god_slots_count(faction_key) do
          ...
          if devoted_general_index then deities.remove_devoted_general(faction_key, god_slots[i].god_key, devoted_general_index, false) end
     end
end, true)

-- general died
core:add_listener("PharLocalDeities_FactionCharacterDiedOrWounded", "FactionCharacterDiedOrWounded", function(context)
     ...
     for i = 1, deities.get_faction_god_slots_count(faction_key) do
          ...
          if devoted_general_index then deities.devoted_general_died(faction_key, god_slots[i].god_key, devoted_general_index) end
     end
end, true)
...
core:add_listener("PharLocalDeities_FactionCharacterDiedOrWoundedHorde", "FactionCharacterDiedOrWounded",
                  function(context) return is_sea_playable_faction(context:faction():name()) end, function(context)
     ...
     if not tribes_privileges.is_horde_type(force) then return end
...
core:add_listener("PharLocalDeities_CharacterEntersMilitaryForceHorde", "CharacterEntersMilitaryForce", true, function(context)
     local character = context:character()
     local force = character:military_force()
     if not force or force:is_null_interface() or not tribes_privileges.is_horde_type(force) then return end
     ...
     if not force_slots then return end
...
core:add_listener("PharLocalDeities_MilitaryForceHordeStatusAboutToChange", "MilitaryForceHordeStatusAboutToChange", true, function(context)
     ...
     if not (tribes_privileges.is_horde_type_string(from_type) and not tribes_privileges.is_horde_type_string(to_type)) then return end
     ...
     for i = 0, last_slot_index do
          ...
          if idol_god then
               local god_slot = deities.get_god_slot(faction_key, idol_god.key)
               if not god_slot then deities.output("Faction " .. faction_key .. " built idol for god " .. idol_god.key .. " but does not worship it!", 10) end
...
core:add_listener("PharLocalDeities_MilitaryForceHordeStatusChanged", "MilitaryForceHordeStatusChanged", true, function(context)
     local force = context:military_force()
     local from_type = context:from_type()
     local to_type = context:to_type()
     if not force or force:is_null_interface() then return end
     ...
     if not (not tribes_privileges.is_horde_type_string(from_type) and tribes_privileges.is_horde_type_string(to_type)) then return end
...
core:add_listener("PharLocalDeities_CharacterLeavesMilitaryForce", "CharacterLeavesMilitaryForce", true, function(context)
     local faction_key = context:character():faction():name()

     if not is_table(deities.persistent[faction_key]) then return end

     local general_family_member_cqi = context:character():family_member():command_queue_index()
     if deities.is_devoted_general(faction_key, general_family_member_cqi) then deities.ui_set_army_id_devoted_icon(general_family_member_cqi, false) end
end, true)

core:add_listener("PharLocalDeities_CharacterEntersMilitaryForce", "CharacterEntersMilitaryForce", true, function(context)
     local faction_key = context:character():faction():name()

     if not is_table(deities.persistent[faction_key]) then return end

     local general_family_member_cqi = context:character():family_member():command_queue_index()
     if deities.is_devoted_general(faction_key, general_family_member_cqi) then deities.ui_set_army_id_devoted_icon(general_family_member_cqi, true) end
end, true)

-- prayer performed
-- horde Sea character forces pray on nomad outposts, the rest pray on shrine outposts
core:add_listener("PharLocalDeities_MadePrayer", "CharacterGarrisonTargetAction", true, function(context)
...
core:add_listener("PharLocalDeities_FactionAchievedVictoryEvent", "FactionAchievedVictoryEvent",
                  function(context) return context:faction():name() == cm:get_local_faction_name(true) end, function(context) deities.hide_discovered_god_animation() end,
                  true)

core:add_listener("PharLocalDeities_LegitimacyPathUnlocked", "LegitimacyPathUnlocked", true,
                  function(context) deities.ai_attempt_to_worship_new_god(context.stored_table.faction_key) end, true)

core:add_listener("PharLocalDeities_ScriptEventFavouredGodUpdated", "ScriptEventFavouredGodUpdated", true, function(context)
     local factions = legitimacy_choice:get_factions_with_legitimacy_object(context.stored_table.legitimacy_path_obj)
     for faction_key, _ in dpairs(factions) do deities.ai_attempt_to_worship_new_god(faction_key) end
end, true)
...
-- panel opened
core:add_listener("PharLocalDeities_PanelOpenedCampaign", "PanelOpenedCampaign", function(context) return context.string == deities.component_ids.panel end,
                  function(context)
     ...
     core:add_listener("PharLocalDeities_ButtonClicked", "ComponentLClickUp", true, function(context)
     ...
     core:add_listener("PharLocalDeities_ButtonClicked_UI", "ContextTriggerEvent", function(context) return context.string:split(":")[1] == "DeitiesButton" end,
                       function(context)
...
core:add_listener("PharLocalDeitiesDiscoveredGods_ButtonClicked_UI", "ContextTriggerEvent", function(context) return context.string:split(":")[1] == "DeitiesButton" end,
                  function(context)
     local splits = context.string:split(":")
     local button_key = splits[2]
     if button_key == deities.commands.discovered_animation_god_selected then
          ...
          if not deities.panel then
               local local_deities_button = core:get_ui_root():SequentialFind(deities.component_ids.local_deities_container, deities.component_ids.local_deities_button)
               if local_deities_button and not local_deities_button:CurrentState():find("inactive") then local_deities_button:SimulateLClick() end
          end
          if deities.panel then deities.open_selected_god(god_key) end
     else
          deities.output("Error: unknown button '" .. button_key .. "'")
     end
end, true)

core:add_listener("PharLocalDeities_AkhenatenButtonClicked", "ComponentLClickUp",
                  function(context) return context.string == deities.component_ids.akhenaten_fm_button end, function(context)
     ...
     if not deities.panel then
          ...
          if state == "selected_down" then
               deities.panel:InterfaceFunction("close_panel")
               local restore_button_state = function() akhenaten_button:SetState("active") end
...
-- Worship a god
core:add_listener("PharLocalDeities_WorshipGod", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_WorshipGod") end,
                  function(context)
...
-- Worship a god
core:add_listener("PharLocalDeities_UnlockSlot", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_UnlockSlot") end,
                  function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
     ...
     -- Update UI if triggered by local faction
     if faction_key == cm:get_local_faction_name(true) then deities.display_god_slots() end
end, true)

-- Create Aten
core:add_listener("PharLocalDeities_CreateAten", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_CreateAten") end,
                  function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
     ...
     local event_data = {faction_key = faction_key, aten_key = deities.config.aten_god_key}
     core:trigger_event("ScriptEventOnAtenCreated", event_data)

     -- Update UI if triggered by local faction
     if faction_key == cm:get_local_faction_name(true) then deities.refresh_god_info() end
end, true)

-- Select Aten unlockable
core:add_listener("PharLocalDeities_SelectUnlockable", "UITriggerScriptEvent",
                  function(context) return string.find(context:trigger(), "PharLocalDeities_SelectUnlockable") end, function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
...
core:add_listener("PharLocalDeities_AssignDevotedGeneral", "UITriggerScriptEvent",
                  function(context) return string.find(context:trigger(), "PharLocalDeities_AssignDevotedGeneral") end, function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
...
core:add_listener("PharLocalDeities_ChangeGod", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_Change") end,
                  function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
     ...
     -- Update UI if triggered by local faction
     if faction_key == cm:get_local_faction_name(true) then deities.display_religious_buildings() end
end, true)

-- Grant favour through cheat
core:add_listener("PharLocalDeities_GrantFavour", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_GrantFavour") end,
                  function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
     ...
     -- Update UI if triggered by local faction
     if faction_key == cm:get_local_faction_name(true) then deities.open_selected_god(deities.ui_data.selected_god) end
end, true)

-- Discover god through cheat
core:add_listener("PharLocalDeities_DiscoverGod", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_DiscoverGod") end,
                  function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
     ...
     -- Update UI if triggered by local faction
     if faction_key == cm:get_local_faction_name(true) then deities.display_all_gods() end
end, true)

core:add_listener("PharLocalDeities_Hecatomb", "UITriggerScriptEvent", function(context) return string.find(context:trigger(), "PharLocalDeities_Hecatomb") end,
                  function(context)
     local faction_cqi = context:faction_cqi()
     local faction = cm:model():faction_for_command_queue_index(faction_cqi)
     local faction_key = faction:name()
...
-- panel closed
core:add_listener("PharLocalDeities_PanelClosedCampaign", "PanelClosedCampaign", function(context) return context.string == deities.component_ids.panel end,
                  function(context)
     deities.panel = nil
...
core:add_listener("PharLocalDeities_PopulateShrineEffects", "OnInitBuildingInfo", true, function(context)
     ...
     if not custom_effect_bundle then custom_effect_bundle = deities.get_dwelling_effects(faction_key, building_chain_key) end
     ...
     if not custom_effect_bundle then return end
...
core:add_listener("PharLocalDeities_RequestAdditionalAgentActionEffects", "RequestAdditionalAgentActionEffects", true, function(context)
     local agent_action_key = context:agent_action_key()
     local character = context:character()

     local additional_effects_bundle = deities.get_bundle_for_prayer(agent_action_key, character)
     if not additional_effects_bundle then return end

     cm:set_info_additional_agent_action_effect_bundle(additional_effects_bundle)
end, true)

core:add_listener("PharLocalDeities_RequestAdditionalERSEffects", "RequestAdditionalERSEffects", true, function(context)
     local garrison_residence = context:garrison_residence()
     if garrison_residence:is_slot() then
          local slot = garrison_residence:slot_interface()
          local faction_key = garrison_residence:faction():name()
...
core:add_listener("PharLocalDeities_notify_god_total_favour_changed", "LocalDeitiesGodTotalFavourChanged",
                  function(context) return context.stored_table.faction_key == cm:get_local_faction_name(true) end, function(context)
...
core:add_listener("PharLocalDeities_TierEntry_OnMouseOn", "ComponentMouseOn", function(context)
     local parent_of_hovered_component = UIComponent(context.component):Parent()
     return
          (parent_of_hovered_component and UIComponent(parent_of_hovered_component):Id() == "tier_holder" and string.find(UIComponent(context.component):Id(), "lock_")) or
               string.find(UIComponent(context.component):Id(), deities.component_ids.tier_indicator)
end, function(context)
     local faction_key = cm:get_local_faction_name(true)
     local god_key = deities.ui_data.selected_god
     if god_key == "" or god_key == nil then return end
     ...
     if tier_index == nil or tier_index == "" then return end

     deities.init_tier_tooltip(UIComponent(context.component), god_key, tonumber(tier_index))
end, true)

core:add_listener("PharLocalDeities_GodPortrait_OnMouseOn", "ComponentMouseOn", function(context)
...
core:add_listener("PharLocalDeities_LegitimacyPathPatronData_PanelOpenedCampaign", "PanelOpenedCampaign",
                  function(context) return context.string == crown.config.ui.crown_panel end, function(context) deities.setup_favoured_god_ui_script_object() end, true)

core:add_listener("PharLocalDeities_LegitimacyPathUnlocked", "LegitimacyPathUnlocked",
                  function(context) return context.stored_table.faction_key == cm:get_local_faction_name(true) end,
                  function(context) deities.setup_favoured_god_ui_script_object() end, true)
...
deities_tests = {
     ...
     print_gods_favour_for_faction = function(faction_key)
          local god_slots = deities.get_god_slots(faction_key)
          if not god_slots then return end

          local unlocked_slots_count = deities.get_faction_god_slots_count(faction_key)
          for i = 1, unlocked_slots_count do
               local god_slot = god_slots[i]
               if god_slot.god_key then out(god_slot.god_key .. " : " .. tostring(god_slot.favour.total_favour)) end
          end
     end
}
